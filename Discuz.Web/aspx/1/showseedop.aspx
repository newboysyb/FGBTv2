<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.showseedop" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n	    <div id=\"floatlayout_topicadmin\">\r\n          <h3 class=\"flb\">\r\n            <em id=\"return_emailfriend\">种子管理操作记录</em>\r\n            <span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('showseedop");
	...
	templateBuilder.Append("\r\n              </em>\r\n          </h3>\r\n          <div class=\"PrivateBTInfoFileListBorder\" id=\"PrivateBTInfoListBorder_showseedop");
	templateBuilder.Append(seedid.ToString());
	templateBuilder.Append("\">\r\n              <div class=\"PrivateBTInfoListBorder2\" id=\"PrivateBTInfoListBorder2_showseedop");
	templateBuilder.Append(seedid.ToString());
	templateBuilder.Append("\">\r\n                    \r\n                       <!--  列表开始 -->\r\n                       <table class=\"PrivateBTOpListTable\">\r\n                           <tr class=\"PrivateBTOpListTitle\">\r\n                              <td width=\"200px\">操作时间</td>\r\n                              <td width=\"10px\"></td>\r\n                              <td align=\"left\">操作内容</td>\r\n                           </tr>\r\n                           ");
	if (seedoplist.Rows.Count==0)
	{

	templateBuilder.Append("<tr class=\"PrivateBTOpList\"><td colspan=\"3\" align=\"left\">该种子没有管理操作记录</td></tr>");
	}	//end if


	int seedop__loop__id=0;
	foreach(DataRow seedop in seedoplist.Rows)
	{
		seedop__loop__id++;

	templateBuilder.Append("\r\n                           <tr class=\"PrivateBTOpList\">\r\n                              <td>" + seedop["date"].ToString().Trim() + "</td>\r\n                              <td align=\"left\"></td>\r\n                              <td align=\"left\">" + seedop["operation"].ToString().Trim() + "</td>\r\n                           </tr>\r\n                           ");
	}	//end loop
