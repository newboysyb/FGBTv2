...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:21.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:21. 
	*/
	...
	templateBuilder.Append("class=\"pm_sysmsg\"");
	}	//end if
	...
	templateBuilder.Append("\r\n        <img width=\"60\" onerror=\"this.onerror=null;this.src='");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("images/common/noavatar_small.gif'\" src=\"icon.png\"/>\r\n		");
	}
	else
	{

	templateBuilder.Append("\r\n        <a href=\"userinfo-");
	templateBuilder.Append(msgfromid.ToString());
	templateBuilder.Append(".aspx\" target=\"_blank\">\r\n        ");	string avatarurl = Avatars.GetAvatarUrl(msgfromid,AvatarSize.Small);
	...
	templateBuilder.Append("<a href=\"forumindex.aspx\">[系统短消息]</a>");
	}	//end if
