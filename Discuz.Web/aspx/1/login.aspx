...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<strong>航行 iHome.buaa.edu.cn 跳转登陆 [ 用户 ");
	templateBuilder.Append(ssoName.ToString());
	templateBuilder.Append(" ] 绑定未来花园BT账号</strong>");
	}
	else
	{

	templateBuilder.Append("用户登录");
	}	//end if
	...
	templateBuilder.Append("	\r\n                                <input type=\"text\" style=\"display:none\" size=\"40\" name=\"reactiveuid\" id=\"reactiveuid\" value=\"");
	templateBuilder.Append(needactiveuid.ToString());
	...
	templateBuilder.Append("\r\n	<div class=\"wrap cl\">\r\n		<div class=\"blr\" id=\"floatlayout_login\">\r\n		<form id=\"form1\" name=\"form1\" method=\"post\" onsubmit=\"return check_vcode();\" ");
	if (loginauth!="")
	{
	...
	templateBuilder.Append("\" tabindex=\"-1\" accesskey=\"r\" title=\"立即注册 (ALT + R)\" class=\"xg2\">立即注册</a>\r\n					");
	}	//end if
