...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:32.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:32. 
	*/

	base.OnInit(e);

	templateBuilder.Capacity = 265122;
	...
	else if (64==(forum.Allowpostspecial&64)&&(usergroupinfo.Groupid>12||usergroupinfo.Groupid<4))
	{

	 newtopicurl = forumpath + "posttopic.aspx?forumid=" + forum.Fid + "&type=seed&forumpage=" + pageid;
	

	}
	else if (128==(forum.Allowpostspecial&128)&&(usergroupinfo.Groupid>13||usergroupinfo.Groupid<4))
	{

	 newtopicurl = forumpath + "posttopic.aspx?forumid=" + forum.Fid + "&type=lottery&forumpage=" + pageid;
	...
	templateBuilder.Append("\r\n				 <!-- 【BT修改】-蓝种============================================== -->\r\n             ");
	if (topic.SeedId>0&&seedinfo.DownloadRatio==0)
	{

	templateBuilder.Append("\r\n                <span title=\"");
	templateBuilder.Append(topic.Title.ToString().Trim());
	templateBuilder.Append("\" style=\"cursor:pointer;\"><span class=\"BTBlue\">");
	templateBuilder.Append(topic.Title.ToString().Trim());
	...
	templateBuilder.Append("	\r\n            <span class=\"drop xg2 y\" onclick=\"showMenu({'ctrlid':this.id, 'pos':'21'})\" id=\"operatSelTop\" style=\"margin-top:16px;margin-right:10px;\">种子管理</span>\r\n            <ul style=\"width: 180px; display:none;\" id=\"operatSelTop_menu\" class=\"p_pop inlinelist\">\r\n              <li><a onclick=\"seedmodthreads(1, 'seeddelete');return false;\" href=\"###\">删除</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seedmove');return false;\" href=\"###\">移动</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seedtop');return false;\" href=\"###\">置顶</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seedratio');return false;\" href=\"###\">流量系数</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seededit');return false;\" href=\"###\">编辑</a></li>\r\n              \r\n              <li><a onclick=\"seedmodthreads(1, 'seeduntop');return false;\" href=\"###\">取消置顶</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seedaward');return false;\" href=\"###\">奖励处罚</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seedclose');return false;\" href=\"###\">关闭打开</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seeddigest');return false;\" href=\"###\">精华</a></li>\r\n              \r\n              <li><a onclick=\"modthreads(1, 'identify');return false;\" href=\"###\">鉴定</a></li>\r\n              <li><a onclick=\"modthreads(1, 'repair');return false;\" href=\"###\">修复</a></li>\r\n              <li><a onclick=\"seedmodthreads(1, 'seedban');return false;\" href=\"###\">屏蔽</a></li>\r\n          ");
	}
	else
	{
	...
	templateBuilder.Append(PTTools.Upload2Str(post.Extcredits3).ToString().Trim());
	...
	templateBuilder.Append(PTTools.Upload2Str(post.Extcredits4).ToString().Trim());
	...
	templateBuilder.Append(PTTools.Upload2Str(post.Extcredits5).ToString().Trim());
	...
	templateBuilder.Append(PTTools.Upload2Str(post.Extcredits6).ToString().Trim());
	...
	templateBuilder.Append(">");
	templateBuilder.Append(post.Username.ToString().Trim());
	templateBuilder.Append("</span>\r\n			</div>\r\n			<div id=\"");
	templateBuilder.Append(post.Posterid.ToString().Trim());
	templateBuilder.Append(loopi.ToString());
	...
	templateBuilder.Append("</span>\r\n					</em>\r\n					<span class=\"pipe\">|</span>主题ID:");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("，帖子ID:");
	templateBuilder.Append(post.Pid.ToString().Trim());
	templateBuilder.Append("\r\n				");
	if (post.Posterid!=-1)
	{
	...
	if (config.Silverlight==1&&topic.Attachment==2&&(topic.SeedId==0||post.Id!=1))
	{
	...
	if (topic.Identify>0&&post.Id==1&&topic.SeedId>0)
	{

	templateBuilder.Append("\r\n					<div class=\"threadstampseed\" onclick=\"this.style.display='none';\"><img src=\"");
	...
	else if (topic.Identify>0&&post.Id==1)
	{
	...
	if (topic.SeedId>0&&post.Layer==0&&post.Id==1)
	{


	if (ratioprotectionNote=="ALERT")
	{

	templateBuilder.Append("\r\n              <div class=\"PrivateBTSeedInfoTableAlert\">\r\n                <table class=\"PrivateBTSeedInfoTableAlert\">\r\n                  <tr class=\"PrivateBTSeedInfoListTitleAlert\">\r\n                    <td style=\"width:50px;\"><img class=\"PrivateBTInlineIMG\" src=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/bt/alert.png\" title=\"共享率保护\"/></td>\r\n                    <td style=\"overflow:hidden;\">\r\n                        <a href=\"usercpratioprotect.aspx\">共享率保护</a>：您的上传不足，但是已经取消共享率保护，可以下载此种子，请务必谨慎保护您的共享率</a><br/>\r\n                        <em>共享率保护防止因为过度下载导致上传严重不足。<a href=\"usercpratioprotect.aspx\"><strong>取消共享率保护</strong></a>可能导致您的账号进入到难以恢复的状态。</em>\r\n                    </td>\r\n                  </tr>\r\n                </table>\r\n              </div>\r\n              <br/>\r\n             ");
	}
	else if (ratioprotectionNote!="")
	{
	...
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/bt/alert.png\" title=\"共享率保护\"/></td>\r\n                    <td style=\"overflow:hidden;\">\r\n                        <a href=\"usercpratioprotect.aspx\">共享率保护</a>：您的上传不足，无法下载此种子。请先下载蓝种，保种获取足够上传之后再下载非蓝种</a><br/>\r\n                        <em>共享率保护防止因为过度下载导致上传严重不足。<a href=\"usercpratioprotect.aspx\"><strong>取消共享率保护</strong></a>可能导致您的账号进入到难以恢复的状态。</em>\r\n                    </td>\r\n                  </tr>\r\n                </table>\r\n              </div>\r\n              <br/>\r\n             ");
	}	//end if

	templateBuilder.Append("\r\n             \r\n              <div class=\"PrivateBTSeedInfoTable\">\r\n                <table class=\"PrivateBTSeedInfoTable\">\r\n                  <tr class=\"PrivateBTSeedInfoListTitle\">\r\n                    <td class=\"PrivateBTSeedInfoListA\"></td>\r\n                    <td class=\"PrivateBTSeedInfoListB\"></td>\r\n                    <td class=\"PrivateBTSeedInfoListC\"></td>\r\n                    <td class=\"PrivateBTSeedInfoListD\"></td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoListTitle\">\r\n                    <td colspan=\"4\" style=\"overflow:hidden;\">\r\n                        种子基本信息&nbsp;&nbsp;&nbsp;");
	templateBuilder.Append(PrivateBT.Type2Name(seedinfo.Type).ToString().Trim());
	templateBuilder.Append("&nbsp;&nbsp;&nbsp;");
	if (blueseednote!="")
	{
	templateBuilder.Append(blueseednote.ToString());
	templateBuilder.Append("&nbsp;&nbsp;&nbsp;");
	}	//end if


	if (seedinfo.Type==1&&imdblink!="")
	{

	templateBuilder.Append("<a href=\"");
	templateBuilder.Append(imdblink.ToString());
	templateBuilder.Append("\">");
	templateBuilder.Append(imdblink.ToString());
	templateBuilder.Append("</a>");
	}	//end if

	templateBuilder.Append("\r\n                    </td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoListDownLink\">\r\n                    <td style=\"overflow:hidden;\"><span class=\"PrivateBTLink_GreenBold\">下载种子：</span></td>\r\n                    <td colspan=\"3\" style=\"overflow:hidden;\">\r\n                        <a href=\"");
	templateBuilder.Append(forumpath.ToString());
	...
	if (seedinfo.FileName!="")
	{

	templateBuilder.Append("\r\n                            <a href=\"downloadseed.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("\"><span class=\"PrivateBTLink_GreenBold\">");
	templateBuilder.Append(seedinfo.FileName.ToString().Trim());
	templateBuilder.Append(".torrent</span></a>\r\n                        ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                    </td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList\">\r\n                    <td class=\"PrivateBTSeedInfoListA\">种子大小：</td>\r\n                    <td class=\"PrivateBTSeedInfoListB\"><a onclick=\"fgbtshowwindow('showseedfile");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedfile.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\">");
	templateBuilder.Append(PTTools.Upload2Str(seedinfo.FileSize,false).ToString().Trim());
	templateBuilder.Append("</a></td>\r\n                    <td class=\"PrivateBTSeedInfoListC\">文件计数：</td>\r\n                    <td class=\"PrivateBTSeedInfoListD\"><a onclick=\"fgbtshowwindow('showseedfile");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedfile.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\">");
	templateBuilder.Append(seedinfo.FileCount.ToString().Trim());
	templateBuilder.Append("</a></td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList\">\r\n                    <td><span class=\"blue\">正在做种：</span></td>\r\n                    <td><a onclick=\"fgbtshowwindow('showseedpeer");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedpeer.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\"><span class=\"blue\">");
	templateBuilder.Append(seedinfo.Upload.ToString().Trim());
	templateBuilder.Append("</span></a></td>\r\n                    <td>总流量：</td>\r\n                    <td>\r\n                        ");
	...
	templateBuilder.Append("\r\n                          ");
	templateBuilder.Append(PTTools.Upload2Str(seedinfo.UpTraffic,false).ToString().Trim());
	templateBuilder.Append("\r\n                          (");
	if (trafficcheck=="blue")
	{
	...
	templateBuilder.Append(PTTools.Upload2Str(seedinfo.UpTraffic-seedinfo.Traffic,false).ToString().Trim());
	templateBuilder.Append(")\r\n                      ");
	}	//end if

	templateBuilder.Append("\r\n                    </td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList\">\r\n                    <td><span class=\"red\">正在下载：</span></td>\r\n                    <td><a onclick=\"fgbtshowwindow('showseedpeer");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedpeer.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\"><span class=\"red\">");
	templateBuilder.Append(seedinfo.Download.ToString().Trim());
	templateBuilder.Append("</span></a></td>\r\n                    <td>上传系数：</td>\r\n                    <td>\r\n                        ");
	templateBuilder.Append(seedinfo.UploadRatio.ToString().Trim());
	templateBuilder.Append("&nbsp;\r\n                        ");
	...
	templateBuilder.Append("\r\n                        &nbsp;");
	templateBuilder.Append(uploadratioNote.ToString());
	templateBuilder.Append("\r\n                    </td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList\">\r\n                    <td>下载完成：</td>\r\n                    <td>");
	templateBuilder.Append(seedinfo.Finished.ToString().Trim());
	templateBuilder.Append("</td>\r\n                    <td>下载系数：</td>\r\n                    <td>\r\n                        ");
	templateBuilder.Append(seedinfo.DownloadRatio.ToString().Trim());
	templateBuilder.Append("&nbsp;                        \r\n                        ");
	...
	templateBuilder.Append("\r\n                        &nbsp;");
	templateBuilder.Append(downloadratioNote.ToString());
	templateBuilder.Append("\r\n                    </td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList\">\r\n                    <td>做种IP：</td>\r\n                    <td>\r\n                              ");
	...
	templateBuilder.Append("\r\n                    <td>最后活动：</td>\r\n                    <td>");
	if (seedinfo.LastLive<seedinfo.PostDateTime)
	{
	...
	{
	templateBuilder.Append(seedinfo.LastLive.ToString().Trim());
	templateBuilder.Append(" (距今");
	templateBuilder.Append(PTTools.Minutes2String((DateTime.Now-seedinfo.LastLive).TotalMinutes).ToString().Trim());
	templateBuilder.Append(")");
	}	//end if
	...
	templateBuilder.Append("</td>\r\n                    <td>做种奖励：</td>\r\n                    <td>");
	templateBuilder.Append(PTTools.Upload2Str(PTSeeds.GetSeedAward(seedinfo.FileSize,seedinfo.Live,seedinfo.Upload),false).ToString().Trim());
	templateBuilder.Append("/h</td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList\">\r\n                    <td>最后做种：</td>\r\n                    <td>");
	if (seedinfo.LastSeederName=="")
	{
	...
	templateBuilder.Append(seedinfo.LastSeederId.ToString().Trim());
	templateBuilder.Append(".aspx\">");
	templateBuilder.Append(seedinfo.LastSeederName.ToString().Trim());
	templateBuilder.Append("</a>");
	}	//end if

	templateBuilder.Append("</td>\r\n                    <td>INFO HASH：</td>\r\n                    <td>");
	templateBuilder.Append(seedinfo.InfoHash.ToString().Trim());
	templateBuilder.Append("</td>\r\n                  </tr>\r\n                <tr class=\"PrivateBTSeedInfoList\">\r\n                    <td colspan=\"4\">\r\n                        <a href=\"showseeds.aspx?type=");
	templateBuilder.Append(PrivateBT.Type2Str(seedinfo.Type).ToString().Trim());
	...
	templateBuilder.Append(PrivateBT.Type2Name(seedinfo.Type).ToString().Trim());
	templateBuilder.Append("\" />\r\n                        </a>&nbsp;\r\n                        <span class=\"PrivateBTSeedInfoListLink\"><a onclick=\"fgbtshowwindow('showseedinfo");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedinfo.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\">种子详细命名信息</a></span>&nbsp;&nbsp;&nbsp;&nbsp;\r\n                        <span class=\"PrivateBTPeerListLink\"><a onclick=\"fgbtshowwindow('showseedpeer");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedpeer.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\">Peer节点信息，共");
	templateBuilder.Append((seedinfo.Upload+seedinfo.Download).ToString().Trim());
	templateBuilder.Append("个</a></span>&nbsp;&nbsp;&nbsp;&nbsp;\r\n                        ");
	if (userid<3)
	{

	templateBuilder.Append("\r\n                        <span class=\"PrivateBTPeerHistoryListLink\"><a onclick=\"fgbtshowwindow('showseedpeerhistory");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedpeerhistory.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\">Peer节点历史记录</a></span>&nbsp;&nbsp;&nbsp;&nbsp;\r\n                        ");
	}	//end if

	templateBuilder.Append("\r\n                        <span class=\"PrivateBTFileListLink\"><a onclick=\"fgbtshowwindow('showseedfile");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedfile.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\">种子包含的文件，共");
	templateBuilder.Append(seedinfo.FileCount.ToString().Trim());
	templateBuilder.Append("个</a></span>&nbsp;&nbsp;&nbsp;&nbsp;\r\n                        <span class=\"PrivateBTSeedOpListLink\"><a onclick=\"fgbtshowwindow('showseedop");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("','showseedop.aspx?seedid=");
	templateBuilder.Append(seedinfo.SeedId.ToString().Trim());
	templateBuilder.Append("')\">种子的管理操作记录</a></span>\r\n                    </td>\r\n                </tr>\r\n                </table>\r\n              </div>\r\n              <br/>\r\n            ");
	}	//end if


	if (topic.SeedId<0&&post.Layer==0&&post.Id==1&&topic.Special==64&&abtseedinfo.Aid>0)
	{

	templateBuilder.Append("   \r\n              <div class=\"PrivateBTSeedInfoTable_s\">\r\n                <table class=\"PrivateBTSeedInfoTable_s\">\r\n                  <tr class=\"PrivateBTSeedInfoListTitle_s\">\r\n                    <td class=\"PrivateBTSeedInfoListA\"></td>\r\n                    <td class=\"PrivateBTSeedInfoListB\"></td>\r\n                    <td class=\"PrivateBTSeedInfoListC\"></td>\r\n                    <td class=\"PrivateBTSeedInfoListD\"></td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoListTitle_s\">\r\n                    <td colspan=\"4\" style=\"overflow:hidden;\">\r\n                        文件交换种子 [ 注意：文件交换种子不计流量 即 永久蓝种，下载种子文件将向发布者支付 1 金币，您现在有 ");
	templateBuilder.Append(btuserinfo.Extcredits2.ToString().Trim());
	templateBuilder.Append(" 金币 ] <a href=\"showtopic-83062.aspx\">如何获取金币？</a>\r\n                    </td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoListDownLink_s\">\r\n                    <td style=\"overflow:hidden;\"><span class=\"PrivateBTLink_GreenBold\">下载种子：</span></td>\r\n                    <td colspan=\"3\" style=\"overflow:hidden;\">\r\n                        <a href=\"javascript:downloadabtseed();\">\r\n                            <img class=\"PrivateBTInlineIMG\" src=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/bt/download.gif\" title=\"下载种子\"/>\r\n                        </a>\r\n                        ");
	if (abtseedinfo.FileName!="")
	{

	templateBuilder.Append("\r\n                            <a href=\"downloadseed.aspx?abtseed=1&seedid=");
	templateBuilder.Append(abtseedinfo.Aid.ToString().Trim());
	templateBuilder.Append("&topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("\"><span class=\"PrivateBTLink_GreenBold\">");
	templateBuilder.Append(abtseedinfo.FileName.ToString().Trim());
	templateBuilder.Append(".torrent</span></a>\r\n                        ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                    </td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList_s\">\r\n                    <td class=\"PrivateBTSeedInfoListA\">种子大小：</td>\r\n                    <td class=\"PrivateBTSeedInfoListB\">");
	templateBuilder.Append(PTTools.Upload2Str(abtseedinfo.FileSize,false).ToString().Trim());
	templateBuilder.Append("</td>\r\n                    <td class=\"PrivateBTSeedInfoListC\">文件计数：</td>\r\n                    <td class=\"PrivateBTSeedInfoListD\">");
	templateBuilder.Append(abtseedinfo.FileCount.ToString().Trim());
	templateBuilder.Append("</td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList_s\">\r\n                    <td><span class=\"blue\">正在做种：</span></td>\r\n                    <td><span class=\"blue\">");
	templateBuilder.Append(abtseedinfo.Upload.ToString().Trim());
	templateBuilder.Append("</span></td>\r\n                    <td>下载完成：</td>\r\n                    <td>");
	templateBuilder.Append(abtseedinfo.Finished.ToString().Trim());
	templateBuilder.Append("</td>\r\n                  </tr>\r\n                  <tr class=\"PrivateBTSeedInfoList_s\">\r\n                    <td><span class=\"red\">正在下载：</span></td>\r\n                    <td><span class=\"red\">");
	templateBuilder.Append(abtseedinfo.Download.ToString().Trim());
	templateBuilder.Append("</span></td>\r\n                    <td>最后活动：</td>\r\n                    <td>");
	if (abtseedinfo.LastLive<DateTime.Parse(topic.Postdatetime))
	{
	...
	{
	templateBuilder.Append(abtseedinfo.LastLive.ToString().Trim());
	templateBuilder.Append(" (距今");
	templateBuilder.Append(PTTools.Minutes2String((DateTime.Now-abtseedinfo.LastLive).TotalMinutes).ToString().Trim());
	templateBuilder.Append(")");
	}	//end if

	templateBuilder.Append("</td>\r\n                  </tr>\r\n               </table>\r\n             </div>\r\n             <span class=\"PrivateBTLink_GreenBold\">由于部分加壳修改版浏览器存在后台隐蔽下载种子、多线程下载等行为，会造成重复下载或下载的文件损坏，请务必使用原版IE、Firefox、Chrome、Opera浏览器下载种子！</span>\r\n             <br/>\r\n             ");
	}	//end if
	...
	templateBuilder.Append("\r\n<!--博彩区开始-->\r\n<div class=\"pollpanel\" style=\"background-color:#FFC;border:1px dotted #F90; padding:10px;\">\r\n	<h4 >\r\n      ");string formatstr1="0.00";
	templateBuilder.Append("\r\n      - 花园博彩：<strong>");
	templateBuilder.Append(topic.Title.ToString().Trim());
	templateBuilder.Append("</strong>\r\n      <br/>- 每注10G上传，最高可投100注，只能投注一个选项\r\n      <br/>- 已由发布者支付基础流量 <b>");
	templateBuilder.Append(lotteryinfo.BaseWager.ToString().Trim());
	templateBuilder.Append("TB</b>\r\n      <br/>- 投注截止时间：<b>");
	templateBuilder.Append(lotteryinfo.EndTime.ToString().Trim());
	templateBuilder.Append(" </b>\r\n      <br/>\r\n      <br/>- 胜出彩金池 = ( 输家总注数 + 基础流量TB数 x 100 ) x 10G\r\n      <br/>- 胜出彩金池分配：");
	templateBuilder.Append((PTLottery.BANKER_RETURN_RATIO*100).ToString(formatstr1).ToString().Trim());
	templateBuilder.Append("%返还庄家，封顶两倍基础流量；");
	templateBuilder.Append((PTLottery.WAGER_RETURN_RATIO*100).ToString(formatstr1).ToString().Trim());
	templateBuilder.Append("%按照投注多少平均分配给胜出者\r\n      <br/>- 赔率计算公式：赔率 = 1 + ( 输家总注数 + 基础流量TB数 x 100 ) x ");
	templateBuilder.Append((PTLottery.WAGER_RETURN_RATIO).ToString(formatstr1).ToString().Trim());
	templateBuilder.Append(" / 赢家总注数\r\n      <br/>- 若胜出，投注数 x 10G x 赔率 即为最后获得的含本金返还流量\r\n\r\n	</h4>\r\n	<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" summary=\"pollpanel\" style=\"width:100%;\">\r\n	<tbody>\r\n	");string formatstr="0.000";

	int lotteryoption__loop__id=0;
	foreach(LotteryOption lotteryoption in PTLottery.GetLotteryOptionList(topicid))
	{
		lotteryoption__loop__id++;

	templateBuilder.Append("\r\n	<tr>\r\n		<td class=\"selector\" style=\"width:400px;background-color:#EFE;border:1px solid #AAA;text-align:center;\">\r\n			选项");
	templateBuilder.Append((lotteryoption.OptionId+1).ToString().Trim());
	templateBuilder.Append("：<br/><span style=\"color:#A60\"><b>");
	templateBuilder.Append(lotteryoption.OptionName.ToString().Trim());
	templateBuilder.Append("</b></span>\r\n      <br/>\r\n      ");
	if (lotterycuroption==-3)
	{

	templateBuilder.Append("\r\n      <button type=\"button\" id=\"lotteryoption");
	templateBuilder.Append(lotteryoption.OptionId.ToString().Trim());
	templateBuilder.Append("submit\" name=\"replysubmit\" class=\"pn\">\r\n          <span id=\"lotteryoption");
	templateBuilder.Append(lotteryoption.OptionId.ToString().Trim());
	templateBuilder.Append("btntxt\">&nbsp;&nbsp;开始时间：");
	templateBuilder.Append(lotteryinfo.StartTime.ToString().Trim());
	templateBuilder.Append("，");
	templateBuilder.Append(PTTools.Second2String((lotteryinfo.StartTime-DateTime.Now).TotalSeconds).ToString().Trim());
	templateBuilder.Append("后&nbsp;&nbsp;</span>\r\n      </button>\r\n      ");
	}
	...
	templateBuilder.Append("\r\n            <button type=\"button\" id=\"lotteryoption");
	templateBuilder.Append(lotteryoption.OptionId.ToString().Trim());
	templateBuilder.Append("submit\" name=\"replysubmit\" onclick=\"showWindow('mods', 'topicadmin.aspx?action=lottery&forumid=");
	templateBuilder.Append(topic.Fid.ToString().Trim());
	templateBuilder.Append("&topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&postid=");
	templateBuilder.Append(post.Id.ToString().Trim());
	templateBuilder.Append("&optionid=");
	templateBuilder.Append(lotteryoption.OptionId.ToString().Trim());
	templateBuilder.Append("&operat=lottery');return false;\" class=\"pn\">\r\n                <span id=\"lotteryoption");
	templateBuilder.Append(lotteryoption.OptionId.ToString().Trim());
	templateBuilder.Append("btntxt\">&nbsp;&nbsp;我要投注&nbsp;&nbsp;</span>\r\n            </button>\r\n        ");
	}	//end if
	...
	templateBuilder.Append("&operat=lottery');return false;\" class=\"pn\">\r\n          <span id=\"lotteryoption");
	templateBuilder.Append(lotteryoption.OptionId.ToString().Trim());
	templateBuilder.Append("btntxt\">&nbsp;&nbsp;追加投注&nbsp;&nbsp;</span>\r\n      </button>\r\n      ");
	}	//end if

	templateBuilder.Append("\r\n      <br/>当前赔率：<b>");
	templateBuilder.Append((1.0+(lotteryinfo.BaseWager*100.0+lotteryinfo.WagerCount-lotteryoption.WagerCount)*PTLottery.WAGER_RETURN_RATIO/(lotteryoption.WagerCount>0?lotteryoption.WagerCount:1)).ToString(formatstr).ToString().Trim());
	templateBuilder.Append("</b>&nbsp;&nbsp;&nbsp;已投注：<b>");
	templateBuilder.Append(lotteryoption.WagerCount.ToString().Trim());
	templateBuilder.Append("</b>注\r\n\r\n      \r\n		</td>\r\n		<td style=\"border:1px solid #AAA;background-color:#FFF;\">\r\n        <div class=\"newrate cl\" style=\"border-top:0px; margin:5px;\">\r\n          <ul class=\"cl\">\r\n            ");int wagerlistcount=0;

	int lotterwager__loop__id=0;
	foreach(LotteryWager lotterwager in PTLottery.GetLotteryWagerList(topicid,lotteryoption.OptionId))
	{
		lotterwager__loop__id++;

	templateBuilder.Append("\r\n\r\n                <li>\r\n                    <div style=\"position: absolute; z-index: 999; clip: rect(auto, auto, auto, auto); left: 421px; top: 5343px; display: none; \" class=\"attach_popup\" id=\"_rate_");
	templateBuilder.Append(lotterwager.Id.ToString().Trim());
	templateBuilder.Append("_menu\">\r\n                      <p class=\"cornerlayger\">");
	templateBuilder.Append(lotterwager.WagerTime.ToString().Trim());
	templateBuilder.Append("&nbsp;<em>");
	templateBuilder.Append(lotterwager.WagerCount.ToString().Trim());
	templateBuilder.Append("注</em></p>\r\n                      <p class=\"minicorner\"/>\r\n                    </div>\r\n\r\n                    <p class=\"rateavatar\" onmouseover=\"showMenu({'ctrlid':this.id, 'pos':'12'})\" id=\"_rate_");
	templateBuilder.Append(lotterwager.Id.ToString().Trim());
	templateBuilder.Append("\" style=\"padding-bottom:0px;margin-bottom:0px;\">\r\n                      <a target=\"_blank\" href=\"userinfo-");
	templateBuilder.Append(lotterwager.Userid.ToString().Trim());
	templateBuilder.Append(".aspx\">\r\n                          <img width=\"48\" height=\"48\" onerror=\"this.onerror=null;this.src='images/common/noavatar_small.gif'\" src=\"");
	templateBuilder.Append(lotterwager.Avatarurl.ToString().Trim());
	templateBuilder.Append("\"/>\r\n                      </a>\r\n                    </p>\r\n                    <p class=\"cl\" style=\"padding-top:0px;margin-top:0px;font-size:12px;\"><a href=\"userinfo-");
	templateBuilder.Append(lotterwager.Userid.ToString().Trim());
	templateBuilder.Append(".aspx\" style=\"text-decoration:none;color:black\">");
	templateBuilder.Append(lotterwager.Username.ToString().Trim());
	templateBuilder.Append("</a></p>\r\n        \r\n                </li>\r\n\r\n                ");	 wagerlistcount = wagerlistcount+1;
	...
	templateBuilder.Append("\r\n                    \r\n                    <!--【END BT修改】BT种子信息显示END===============================================================================================-->\r\n                    ");
	if (price>0)
	{

	templateBuilder.Append("<div class='hintinfo'>该主题设置了主题售价");
	templateBuilder.Append(price.ToString());
	templateBuilder.Append(", 您拥有管理权限, 以下是帖子内容</div>");
	}	//end if
	...
	templateBuilder.Append("<span style=\"font-size:24px;\">");
	templateBuilder.Append(topic.Price.ToString().Trim());
	templateBuilder.Append("G</span>");
	}
	else
	{
	templateBuilder.Append(topic.Price.ToString().Trim());
	templateBuilder.Append("G");
	}	//end if
	...
	templateBuilder.Append("\r\n                            <h4 class=\"psth\" style=\"background-color:#666666\">管理结贴，无有价值种子</h4>\r\n                        ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                            <h4 class=\"psth\" style=\"background-color:#fff4dd\">最佳种子</h4>\r\n                            ");	 isshowbest = true;
	...
	templateBuilder.Append("\r\n                            <h4 class=\"psth\" style=\"background-color:#cce2f8\">有价值种子</h4>\r\n                            ");	 isshowvaluable = true;
	...
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("';$('postsform').submit();return false\" >马上投票</button>\r\n				");
	}
	else
	{
	...
	templateBuilder.Append("&topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("&operat=bonus\" onclick=\"showWindow('mods', this.href);return false;\">派发悬赏</a><span class=\"pipe\">|</span>\r\n              <a href=\"topicadmin.aspx?action=closebonus&forumid=");
	templateBuilder.Append(forumid.ToString());
	templateBuilder.Append("&topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("&operat=closebonus\" onclick=\"showWindow('mods', this.href);return false;\">无答案结束悬赏</a><span class=\"pipe\">|</span>\r\n					");
	}
	else
	{
	...
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(forumpageid.ToString());
	templateBuilder.Append("&quote=yes&postlayer=");
	templateBuilder.Append(post.Id.ToString().Trim());
	templateBuilder.Append("&poster=");
	templateBuilder.Append(Utils.UrlEncode(post.Poster).ToString().Trim());
	templateBuilder.Append("\" class=\"repquote\">引用</a>\r\n		");
	}	//end if
	...
	templateBuilder.Append("\r\n			<a href=\"edit.aspx?seedid=");
	templateBuilder.Append(topic.SeedId.ToString().Trim());
	templateBuilder.Append("\" class=\"editpost\" title=\"编辑我的种子\">编辑</a>\r\n			");
	}
	else if (topic.Special==4)
	{
	...
	if (post.Posterid!=-1&&userid==post.Posterid&&allowselfdel==true)
	{
	...
	templateBuilder.Append("\r\n              <a onclick=\"seedmodthreads(1, 'seeddelete');return false;\" href=\"###\" class=\"delpost\" title=\"删除我的种子\">删除</a>\r\n          ");
	}
	else
	{
	...
	else if (post.Posterid!=-1&&userid==post.Posterid&&post.Layer==0&&allowselfclose==true&&forumid==37)
	{
	...
	templateBuilder.Append("&postid=");
	templateBuilder.Append(post.Pid.ToString().Trim());
	templateBuilder.Append("&action=closesink\" onclick=\"return confirm('确定要结束主题吗? 帖子将关闭下沉');\" class=\"delpost\" title=\"交易完成结束主题\">交易完成结束主题</a>\r\n			");
	}	//end if
	...
	else if (topic.Closed==0||(DateTime.Now-DateTime.Parse(topic.Postdatetime)).TotalHours<72)
	{
	...
	templateBuilder.Append("\r\n            <a onclick=\"seedmodthreads(1, 'seeddeleteself');return false;\" href=\"###\" class=\"delpost\" title=\"删除我的种子\">删除</a>\r\n        ");
	}
	else if (allowselfdel==true||post.Layer!=0)
	{
	...
	else if (allowselfclose==true&&forumid==37)
	{
	...
	if (useradminid>0||userid==topic.Posterid&&topic.SeedId>0)
	{
	...
	templateBuilder.Append("\r\n            <form id=\"seedmoderate\" name=\"seedmoderate\" method=\"post\" action=\"seedadmin.aspx?action=moderate&forumid=");
	templateBuilder.Append(forumid.ToString());
	...
	templateBuilder.Append("\r\n              <span class=\"drop xg2\" onclick=\"showMenu({'ctrlid':this.id, 'pos':'21'})\" id=\"operatSel\">种子管理</span>\r\n              <ul style=\"width: 180px; display:none;\" id=\"operatSel_menu\" class=\"p_pop inlinelist\">\r\n                <li><a onclick=\"seedmodthreads(1, 'seeddelete');return false;\" href=\"###\">删除</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seedmove');return false;\" href=\"###\">移动</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seedtop');return false;\" href=\"###\">置顶</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seedratio');return false;\" href=\"###\">流量系数</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seededit');return false;\" href=\"###\">编辑</a></li>\r\n                \r\n                <li><a onclick=\"seedmodthreads(1, 'seeduntop');return false;\" href=\"###\">取消置顶</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seedaward');return false;\" href=\"###\">奖励处罚</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seedclose');return false;\" href=\"###\">关闭打开</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seeddigest');return false;\" href=\"###\">精华</a></li>\r\n                \r\n                <li><a onclick=\"modthreads(1, 'identify');return false;\" href=\"###\">鉴定</a></li>\r\n                <li><a onclick=\"modthreads(1, 'repair');return false;\" href=\"###\">修复</a></li>\r\n                <li><a onclick=\"seedmodthreads(1, 'seedban');return false;\" href=\"###\">屏蔽</a></li>\r\n              </ul>\r\n              ");
	}
	else
	{
	...
	templateBuilder.Append(nextpageurl.ToString());
	templateBuilder.Append("'\">\r\n  <a href=\"");
	templateBuilder.Append(nextpageurl.ToString());
	...
	templateBuilder.Append("\r\n			<div class=\"pbt cl\" id=\"toreplay_div\">\r\n			<strong>回复 <a target=\"_blank\" href=\"showtopic.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&postid=");
	templateBuilder.Append(postid.ToString());
	templateBuilder.Append("#");
	...
	templateBuilder.Append("\r\n\r\n              <div id=\"PrivateBTQuickFloatSmilesShowDiv\" class=\"PrivateBTQuickSmilesShowDiv\">\r\n                  <div class=\"smiliesgroup\" style=\"margin-right: 0pt;\">\r\n                  <ul>\r\n                      ");	string BTQuickFloatdefaulttypname = string.Empty;
	

	int BTQuickFloatstype__loop__id=0;
	foreach(DataRow BTQuickFloatstype in Caches.GetSmilieTypesCache().Rows)
	{
		BTQuickFloatstype__loop__id++;


	if (BTQuickFloatstype__loop__id==1)
	{

	 BTQuickFloatdefaulttypname = BTQuickFloatstype["code"].ToString().Trim();
	...
	templateBuilder.Append("\r\n                        <li id=\"BTQuickFloatt_s_" + BTQuickFloatstype__loop__id.ToString() + "\"><a id=\"BTQuickFloats_" + BTQuickFloatstype__loop__id.ToString() + "\" hidefocus=\"true\" href=\"javascript:;\" onclick=\"BTQuickshowsmiles(" + BTQuickFloatstype__loop__id.ToString() + ", '" + BTQuickFloatstype["code"].ToString().Trim() + "', 1, 'BTQuickFloat', '');\" class=\"current\">" + BTQuickFloatstype["code"].ToString().Trim() + "</a></li>\r\n                        ");
	}
	else
	{

	templateBuilder.Append("\r\n                        <li id=\"BTQuickFloatt_s_" + BTQuickFloatstype__loop__id.ToString() + "\"><a id=\"BTQuickFloats_" + BTQuickFloatstype__loop__id.ToString() + "\" hidefocus=\"true\" href=\"javascript:;\" onclick=\"BTQuickshowsmiles(" + BTQuickFloatstype__loop__id.ToString() + ", '" + BTQuickFloatstype["code"].ToString().Trim() + "', 1, 'BTQuickFloat', '');\">" + BTQuickFloatstype["code"].ToString().Trim() + "</a></li>\r\n                        ");
	}	//end if


	}	//end loop

	templateBuilder.Append("\r\n                  </ul>\r\n                 </div>\r\n                 <div style=\"clear: both;\" class=\"float_typeid\" id=\"BTQuickFloatshowsmilie\"></div>\r\n                 <div id=\"BTQuickFloatshowsmilie_pagenum\" class=\"smilieslist_page\">&nbsp;</div>\r\n                 <script type=\"text/javascript\" reload=\"1\">\r\n                      var BTQuickFloatsmilies_HASH = {};\r\n                     \r\n                      function BTQuickFloatgetSmilies(func){\r\n\r\n                        if($('BTQuickFloatshowsmilie').innerHTML !='' && $('BTQuickFloatshowsmilie').innerHTML != '正在加载表情...')\r\n                          return;\r\n                        var c = \"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("tools/ajax.aspx?t=smilies\";\r\n                        _sendRequest(c,function(d){var e={};try{e=eval(\"(\"+d+\")\")}catch(f){e={}}var h=e?e:null;func(h);e=null;func=null},false,true);\r\n                        setTimeout(\"if($('BTQuickFloatshowsmilie').innerHTML=='')$('BTQuickFloatshowsmilie').innerHTML = '正在加载表情...'\", 2000);\r\n                        \r\n                      }\r\n                      function BTQuickFloatgetSmilies_callback(obj) {\r\n\r\n                        BTQuickFloatsmilies_HASH = obj; \r\n                        BTQuickshowsmiles(1, '");
	templateBuilder.Append(BTQuickFloatdefaulttypname.ToString());
	templateBuilder.Append("', 1, 'BTQuickFloat', '');\r\n                      }\r\n                      \r\n                      BTQuickFloatgetSmilies(BTQuickFloatgetSmilies_callback);\r\n                </");
	templateBuilder.Append("script>\r\n              </div>\r\n          ");
	}
	else
	{

	templateBuilder.Append("\r\n\r\n              <div id=\"PrivateBTQuickSmilesShowDiv\" class=\"PrivateBTQuickSmilesShowDiv\">\r\n                  <div class=\"smiliesgroup\" style=\"margin-right: 0pt;\">\r\n                  <ul>\r\n                      ");	string BTQuickdefaulttypname = string.Empty;
	

	int BTQuickstype__loop__id=0;
	foreach(DataRow BTQuickstype in Caches.GetSmilieTypesCache().Rows)
	{
		BTQuickstype__loop__id++;


	if (BTQuickstype__loop__id==1)
	{

	 BTQuickdefaulttypname = BTQuickstype["code"].ToString().Trim();
	...
	templateBuilder.Append("\r\n                        <li id=\"BTQuickt_s_" + BTQuickstype__loop__id.ToString() + "\"><a id=\"BTQuicks_" + BTQuickstype__loop__id.ToString() + "\" hidefocus=\"true\" href=\"javascript:;\" onclick=\"BTQuickshowsmiles(" + BTQuickstype__loop__id.ToString() + ", '" + BTQuickstype["code"].ToString().Trim() + "', 1, 'BTQuick', 'quickpost');\" class=\"current\">" + BTQuickstype["code"].ToString().Trim() + "</a></li>\r\n                        ");
	}
	else
	{

	templateBuilder.Append("\r\n                        <li id=\"BTQuickt_s_" + BTQuickstype__loop__id.ToString() + "\"><a id=\"BTQuicks_" + BTQuickstype__loop__id.ToString() + "\" hidefocus=\"true\" href=\"javascript:;\" onclick=\"BTQuickshowsmiles(" + BTQuickstype__loop__id.ToString() + ", '" + BTQuickstype["code"].ToString().Trim() + "', 1, 'BTQuick', 'quickpost');\">" + BTQuickstype["code"].ToString().Trim() + "</a></li>\r\n                        ");
	}	//end if


	}	//end loop

	templateBuilder.Append("\r\n                  </ul>\r\n                 </div>\r\n                 <div style=\"clear: both;\" class=\"float_typeid\" id=\"BTQuickshowsmilie\"></div>\r\n                 <div id=\"BTQuickshowsmilie_pagenum\" class=\"smilieslist_page\">&nbsp;</div>\r\n                 <script type=\"text/javascript\" reload=\"1\">\r\n                      var BTQuicksmilies_HASH = {};\r\n                     \r\n                      function BTQuickgetSmilies(func){\r\n\r\n                        if($('BTQuickshowsmilie').innerHTML !='' && $('BTQuickshowsmilie').innerHTML != '正在加载表情...')\r\n                          return;\r\n                        var c = \"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("tools/ajax.aspx?t=smilies\";\r\n                        _sendRequest(c,function(d){var e={};try{e=eval(\"(\"+d+\")\")}catch(f){e={}}var h=e?e:null;func(h);e=null;func=null},false,true);\r\n                        setTimeout(\"if($('BTQuickshowsmilie').innerHTML=='')$('BTQuickshowsmilie').innerHTML = '正在加载表情...'\", 2000);\r\n                        \r\n                      }\r\n                      function BTQuickgetSmilies_callback(obj) {\r\n\r\n                        BTQuicksmilies_HASH = obj; \r\n                        BTQuickshowsmiles(1, '");
	templateBuilder.Append(BTQuickdefaulttypname.ToString());
	templateBuilder.Append("', 1, 'BTQuick', 'quickpost');\r\n                      }\r\n                      \r\n                      BTQuickgetSmilies(BTQuickgetSmilies_callback);\r\n                </");
	templateBuilder.Append("script>\r\n              </div>\r\n          ");
	}	//end if
	...
	if ((forum.Allowpostspecial&64)==64 && (usergroupinfo.Groupid>12||usergroupinfo.Groupid<4))
	{

	templateBuilder.Append("\r\n		<li class=\"seed\"><a href=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("posttopic.aspx?forumid=");
	templateBuilder.Append(forum.Fid.ToString().Trim());
	templateBuilder.Append("&type=seed&forumpage=");
	templateBuilder.Append(pageid.ToString());
	templateBuilder.Append("\" >发交换种子</a></li>\r\n  ");
	}	//end if


	if ((forum.Allowpostspecial&128)==128 && (usergroupinfo.Groupid>13||usergroupinfo.Groupid<4))
	{

	templateBuilder.Append("\r\n		<li class=\"lottery\"><a href=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("posttopic.aspx?forumid=");
	templateBuilder.Append(forum.Fid.ToString().Trim());
	templateBuilder.Append("&type=lottery&forumpage=");
	templateBuilder.Append(pageid.ToString());
	templateBuilder.Append("\" >发起博彩</a></li>\r\n	");
	}	//end if
