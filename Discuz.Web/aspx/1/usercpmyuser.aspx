<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpmyuser" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>我邀请的用户</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("\r\n<ul class=\"f_tab\">\r\n		<li ");
	if (pagename=="usercpinvitation.aspx")
	{

	templateBuilder.Append("class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpinvitation.aspx\">购买邀请</a></li>\r\n		<li ");
	if (pagename=="usercpmyinvitation.aspx")
	{

	templateBuilder.Append("class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpmyinvitation.aspx\">我的邀请</a></li>\r\n		<li ");
	if (pagename=="usercpusedinvitation.aspx")
	{

	templateBuilder.Append("class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpusedinvitation.aspx\">过期/已用邀请</a></li>\r\n		<li ");
	if (pagename=="usercpmyuser.aspx")
	{

	templateBuilder.Append("class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpmyuser.aspx\">我邀请的用户</a></li>\r\n</ul>\r\n");
	}	//end if
	...
	templateBuilder.Append("		\r\n            <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"datatable\">\r\n              <caption>\r\n                <div class=\"hintinfo\" style=\"margin:0;\">\r\n                    <p>请注意：如果被邀请人因为严重违反论坛相关规定被管理人员禁封，您将受到扣除500G上传的处罚。详情请查看公告区通知</p>\r\n                    <p>请注意：邀请人真实上传达到一定值，您将获得奖励上传，最多可达270G。详情请查看公告区通知</p>\r\n                </div>\r\n                <br/>\r\n              </caption>\r\n				  		<tr class=\"colplural\">\r\n				  		<td width=\"5%\">序号</th>\r\n				  		<th width=\"10%\">邀请码id</th>\r\n							<th width=\"5%\">用户id</th>\r\n							<th width=\"10%\">用户名</th>\r\n							<th width=\"8%\">用户级别</th>\r\n							<th width=\"10%\">上传</th>\r\n							<th width=\"10%\">下载</th>\r\n							<th width=\"5%\">共享率</th>\r\n							<th width=\"20%\">注册时间</th>\r\n							<th width=\"20%\">最后访问</th>\r\n						</tr>\r\n						");
	int myuser__loop__id=0;
	foreach(DataRow myuser in userlist.Rows)
	{
		myuser__loop__id++;

	templateBuilder.Append("\r\n						<tbody>\r\n						<tr class=\"messagetable\" onmouseover=\"this.className='messagetableon'\" onmouseout=\"this.className='messagetable'\">\r\n                          <td>" + myuser["sn"].ToString().Trim() + "</td>\r\n                          <td>" + myuser["id"].ToString().Trim() + "</td>\r\n                          <td>" + myuser["registerid"].ToString().Trim() + "</td>\r\n                          <td>\r\n                          ");	 aspxrewriteurl = this.UserInfoAspxRewrite(myuser["registerid"].ToString().Trim());
	
	templateBuilder.Append("\r\n                          <a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" target=\"_blank\">" + myuser["username"].ToString().Trim() + "</a></td>\r\n                          <td>" + myuser["group"].ToString().Trim() + "</td>\r\n                          <td>" + myuser["up"].ToString().Trim() + "</td>\r\n                          <td>" + myuser["down"].ToString().Trim() + "</td>\r\n                          <td>" + myuser["rat"].ToString().Trim() + "</td>\r\n                          <td>" + myuser["joindate"].ToString().Trim() + "</td>\r\n                          <td>" + myuser["lastvisit"].ToString().Trim() + "</td>\r\n						</tr>\r\n						</tbody>\r\n						");
	}	//end loop
