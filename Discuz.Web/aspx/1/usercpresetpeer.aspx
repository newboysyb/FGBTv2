<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpresetpeer" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:20.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:20. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>重置上传下载列表</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("\r\n        <form action=\"\" method=\"post\" id=\"postform\">\r\n        <table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"共享率保护\">\r\n          <caption>\r\n            <div class=\"hintinfo\" style=\"margin:0;\">\r\n                <p>此功能用以 “当客户端机器因意外掉电等原因重新启动uTorrent，此时服务器端仍保留有之前上传下载记录，从而导致出现红种” 的情况</p>\r\n                <p>操作过程：请先将所有种子停止，然后使用清空上传功能，之后再重新开启所有任务</p>\r\n                <p>注意：请勿频繁使用此功能，否则将造成上传流量统计不全、下载被重复统计等后果</p>\r\n            </div>\r\n          </caption>\r\n          <tbody>\r\n          <tr>\r\n              <th>正在上传的种子数:</th>\r\n              <td>\r\n                  <a href=\"");
	templateBuilder.Append(forumurl.ToString());
