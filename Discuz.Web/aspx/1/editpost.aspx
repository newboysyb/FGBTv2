...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:35.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:35. 
	*/
	...
	if (64==(forum.Allowpostspecial&64)&&(usergroupinfo.Groupid>12||usergroupinfo.Groupid<4))
	{
	...
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(forumpageid.ToString());
	templateBuilder.Append("&type=seed&cedit=yes')\" href=\"javascript:;\">发文件交换种子</a></li>\r\n                ");
	}	//end if


	if (128==(forum.Allowpostspecial&128)&&(usergroupinfo.Groupid>12||usergroupinfo.Groupid<4))
	{
	...
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(forumpageid.ToString());
	templateBuilder.Append("&type=lottery&cedit=yes')\" href=\"javascript:;\">发起博彩</a></li>\r\n                ");
	}	//end if
	...
	templateBuilder.Append("\r\n                    <div style=\"display:none;\">\r\n                        <div id=\"toreplay_div\"><strong>回复 <a target=\"_blank\" href=\"showtopic.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&postid=");
	templateBuilder.Append(postid.ToString());
	templateBuilder.Append("#");
	...
	templateBuilder.Append("\" />\r\n		");
	if ((special==""||special=="seed") && isfirstpost)
	{
	...
	templateBuilder.Append("script>\r\n<div id=\"PrivateBTQuickTopicSmilesShowDiv\" class=\"PrivateBTQuickSmilesShowDiv\">\r\n            <div class=\"smiliesgroup\" style=\"margin-right: 0pt;\">\r\n            <ul>\r\n                ");	string BTQuickTopicdefaulttypname = string.Empty;
	

	int BTQuickTopicstype__loop__id=0;
	foreach(DataRow BTQuickTopicstype in Caches.GetSmilieTypesCache().Rows)
	{
		BTQuickTopicstype__loop__id++;


	if (BTQuickTopicstype__loop__id==1)
	{

	 BTQuickTopicdefaulttypname = BTQuickTopicstype["code"].ToString().Trim();
	...
	templateBuilder.Append("\r\n                  <li id=\"BTQuickTopict_s_" + BTQuickTopicstype__loop__id.ToString() + "\"><a id=\"BTQuickTopics_" + BTQuickTopicstype__loop__id.ToString() + "\" hidefocus=\"true\" href=\"javascript:;\" onclick=\"BTQuickshowsmiles(" + BTQuickTopicstype__loop__id.ToString() + ", '" + BTQuickTopicstype["code"].ToString().Trim() + "', 1, 'BTQuickTopic', '');\" class=\"current\">" + BTQuickTopicstype["code"].ToString().Trim() + "</a></li>\r\n                  ");
	}
	else
	{

	templateBuilder.Append("\r\n                  <li id=\"BTQuickTopict_s_" + BTQuickTopicstype__loop__id.ToString() + "\"><a id=\"BTQuickTopics_" + BTQuickTopicstype__loop__id.ToString() + "\" hidefocus=\"true\" href=\"javascript:;\" onclick=\"BTQuickshowsmiles(" + BTQuickTopicstype__loop__id.ToString() + ", '" + BTQuickTopicstype["code"].ToString().Trim() + "', 1, 'BTQuickTopic', '');\">" + BTQuickTopicstype["code"].ToString().Trim() + "</a></li>\r\n                  ");
	}	//end if


	}	//end loop

	templateBuilder.Append("\r\n            </ul>\r\n           </div>\r\n           <div style=\"clear: both;\" class=\"float_typeid\" id=\"BTQuickTopicshowsmilie\"></div>\r\n           <div id=\"BTQuickTopicshowsmilie_pagenum\" class=\"smilieslist_page\">&nbsp;</div>\r\n           <script type=\"text/javascript\" reload=\"1\">\r\n                var BTQuickTopicsmilies_HASH = {};\r\n               \r\n                function BTQuickTopicgetSmilies(func){\r\n\r\n                  if($('BTQuickTopicshowsmilie').innerHTML !='' && $('BTQuickTopicshowsmilie').innerHTML != '正在加载表情...')\r\n                    return;\r\n                  var c = \"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("tools/ajax.aspx?t=smilies\";\r\n                  _sendRequest(c,function(d){var e={};try{e=eval(\"(\"+d+\")\")}catch(f){e={}}var h=e?e:null;func(h);e=null;func=null},false,true);\r\n                  setTimeout(\"if($('BTQuickTopicshowsmilie').innerHTML=='')$('BTQuickTopicshowsmilie').innerHTML = '正在加载表情...'\", 2000);\r\n                  \r\n                }\r\n                function BTQuickTopicgetSmilies_callback(obj) {\r\n\r\n                  BTQuickTopicsmilies_HASH = obj; \r\n                  BTQuickshowsmiles(1, '");
	templateBuilder.Append(BTQuickTopicdefaulttypname.ToString());
	templateBuilder.Append("', 1, 'BTQuickTopic', '');\r\n                }\r\n                \r\n                BTQuickTopicgetSmilies(BTQuickTopicgetSmilies_callback);\r\n          </");
	...
	templateBuilder.Append("GB上传 (只允许正整数，只能保持不变或增加)\r\n		[ 悬赏范围 ");
	templateBuilder.Append(topic.Price.ToString().Trim());
	templateBuilder.Append("GB - ");
	templateBuilder.Append(usergroupinfo.Maxbonusprice.ToString().Trim());
	templateBuilder.Append("GB, 当前可用 ");
	templateBuilder.Append(PTTools.Upload2Str(mybonustranscredits).ToString().Trim());
	templateBuilder.Append(" ]\r\n		[ 增加税后支付 <span id=\"realprice\">0GB</span>， 增加支付中的<span id=\"returnprice\">0GB</span>将在结贴时返还]");
	}
	else
	{

	templateBuilder.Append("GB上传 (管理操作：设置为0将关闭主题并返还悬赏，其余数值无效)");
	}	//end if

	templateBuilder.Append("\r\n		<script type=\"text/javascript\" reload=\"1\">\r\n			function getrealprice(price) {\r\n				if (!price.search(/^\\d+$/)) {\r\n					n = 2.0 * (parseInt(price) - ");
	templateBuilder.Append(topic.Price.ToString().Trim());
	templateBuilder.Append(") + 1.0 * (parseInt(price) - ");
	templateBuilder.Append(topic.Price.ToString().Trim());
	templateBuilder.Append(") * ");
	templateBuilder.Append(Scoresets.GetCreditsTax().ToString().Trim());
	templateBuilder.Append(";\r\n					if (price < ");
	templateBuilder.Append(topic.Price.ToString().Trim());
	templateBuilder.Append(") {$('realprice').innerHTML = '<b>悬赏不能低于 ");
	templateBuilder.Append(topic.Price.ToString().Trim());
	templateBuilder.Append("GB</b>';\r\n					} else if (price > 32767) {\r\n						$('realprice').innerHTML = '<b>悬赏不能高于 32767GB</b>';\r\n						$('returnprice').innerHTML = '-'\r\n					} else if (price < ");
	templateBuilder.Append(usergroupinfo.Minbonusprice.ToString().Trim());
	templateBuilder.Append(" || (price > ");
	templateBuilder.Append(usergroupinfo.Maxbonusprice.ToString().Trim());
	templateBuilder.Append(")) {\r\n						$('realprice').innerHTML = '<b>悬赏超出范围</b>';\r\n						$('returnprice').innerHTML = '-'\r\n					} else {\r\n						$('realprice').innerHTML = n + 'GB';\r\n						$('returnprice').innerHTML = (parseInt(price) - ");
	templateBuilder.Append(topic.Price.ToString().Trim());
	...
	else if (topic.Special==128&&caneditlottery==1)
	{

	templateBuilder.Append("\r\n    <div class=\"exfm cl\">\r\n			<div class=\"sinf z\">\r\n				<div class=\"cl\">\r\n					<h4><em>选项:</em>每行填写 1 个选项（请确保最终 有且仅有 1个结果）</h4>\r\n				</div>\r\n				<div id=\"polloptions\" class=\"mbm\">\r\n				<input id=\"PollItemname\" type=\"hidden\" name=\"PollItemname\" value=\"\" />\r\n				<input id=\"PollItemvalue\" type=\"hidden\" name=\"PollItemvalue\" value=\"\" />\r\n				<input type=\"hidden\" name=\"updatelottery\" id=\"updatelottery\" value=\"1\" />\r\n          ");
	...
	templateBuilder.Append("\r\n            <p ");
	if (lotteryoption.OptionId==0)
	{

	templateBuilder.Append("id=\"divPollItem\" ");
	}	//end if

	templateBuilder.Append(" name=\"PollItem\">\r\n              <input type=\"text\" id=\"pollitemid\"  name=\"pollitemid\" value=\"");
	templateBuilder.Append(lotteryoption.OptionName.ToString().Trim());
	templateBuilder.Append("\" class=\"txt\" tabindex=\"1\" style=\"width:340px;\" />\r\n              <a href=\"javascript:;\" class=\"del y\" title=\"删除博彩项\" onclick=\"if(!delObj(document.getElementById('polloptions'),2,this.parentNode)){alert('投票项不能少于2个');}\">del</a>\r\n            </p>\r\n          ");
	}	//end loop

	templateBuilder.Append("\r\n				</div>\r\n				<p><a onclick=\"clonePoll('");
	templateBuilder.Append(config.Maxpolloptions.ToString().Trim());
	templateBuilder.Append("')\" href=\"javascript:;\">+增加博彩项</a></p>\r\n			</div>\r\n			<div class=\"sadd z\">\r\n			  <p class=\"mbn\"><label for=\"polldatas\">基础发布投注额，由发布者支付<br/>最少1TB，以TB为单位</label>\r\n          <input name=\"basewager\" id=\"basewager\" size=\"5\"  value=\"");
	templateBuilder.Append(lotteryinfo.BaseWager.ToString().Trim());
	templateBuilder.Append("\"/>TB (只能增加数额）\r\n			  </p>\r\n			  <p></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">博彩结束日期</label>\r\n					<input name=\"enddatetime\" type=\"text\" id=\"enddatetime\" size=\"10\" value=\"");
	templateBuilder.Append(lotteryinfo.EndTime.Year.ToString().Trim());
	templateBuilder.Append("-");
	templateBuilder.Append(lotteryinfo.EndTime.Month.ToString().Trim());
	templateBuilder.Append("-");
	templateBuilder.Append(lotteryinfo.EndTime.Day.ToString().Trim());
	...
	templateBuilder.Append(lotteryinfo.EndTime.Day.ToString().Trim());
	templateBuilder.Append("');\" readonly=\"readonly\" />\r\n					<input type=\"hidden\" name=\"cal_startdate\" id=\"cal_startdate\" size=\"10\"  value=\"");
	templateBuilder.Append(DateTime.Now.Year.ToString().Trim());
	templateBuilder.Append("-");
	templateBuilder.Append(DateTime.Now.Month.ToString().Trim());
	templateBuilder.Append("-");
	templateBuilder.Append(DateTime.Now.Day.ToString().Trim());
	templateBuilder.Append("\"/>\r\n					<input type=\"hidden\" name=\"cal_enddate\" id=\"cal_enddate\" size=\"10\"  value=\"\"/>\r\n				</p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">博彩结束时间</label>\r\n          <input name=\"cal_endtimehour\" id=\"cal_endtimehour\" size=\"5\"  value=\"");
	templateBuilder.Append(lotteryinfo.EndTime.Hour.ToString().Trim());
	templateBuilder.Append("\"/>时\r\n          <input name=\"cal_endtimemins\" id=\"cal_endtimemins\" size=\"5\"  value=\"");
	templateBuilder.Append(lotteryinfo.EndTime.Minute.ToString().Trim());
	templateBuilder.Append("\"/>分\r\n          <input name=\"createlottery\" type=\"hidden\" id=\"createlottery\" value=\"1\" />\r\n				</p>\r\n				");string formatstr="0.00";
	templateBuilder.Append("\r\n				<p class=\"mbn\"><label for=\"polldatas\" style=\"color:red\"><b>发布【必须】先联系版主【许可】！删贴流量不退！</b></label></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">胜出彩金池 = 所有输者的投注额 + 基础发布投注</label></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">胜出彩金池分配：");
	templateBuilder.Append((PTLottery.WAGER_RETURN_RATIO*100).ToString(formatstr).ToString().Trim());
	templateBuilder.Append("%平均分配给胜者</label></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">返还庄家");
	templateBuilder.Append((PTLottery.BANKER_RETURN_RATIO*100).ToString(formatstr).ToString().Trim());
	templateBuilder.Append("%（封顶2倍基础流量）</label></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">发布者不能进行普通投注，博彩发布60分钟内可编辑</label></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">60分钟后开放投注，不可编辑。结束后可编辑选择结果</label></p>\r\n			</div>\r\n		</div>\r\n		  <script type=\"text/javascript\">\r\n         if(typeof verctrl_post == 'undefined' || verctrl_post != '20140616')\r\n         {\r\n              alert(\"请按Ctrl + F5刷新页面，直到本提示不再出现方可发布\");\r\n         }\r\n      </");
	templateBuilder.Append("script>\r\n    ");
	}
	else if (topic.Special==128&&caneditlottery==2)
	{

	templateBuilder.Append("\r\n    <div class=\"exfm cl\">\r\n			<div class=\"sinf z\">\r\n				<div class=\"cl\">\r\n					<h4><em>选项:</em>选择胜出的最终结果</h4>\r\n				</div>\r\n				<div id=\"polloptions\" class=\"mbm\">\r\n				<input id=\"PollItemname\" type=\"hidden\" name=\"PollItemname\" value=\"\" />\r\n				<input id=\"PollItemvalue\" type=\"hidden\" name=\"PollItemvalue\" value=\"\" />\r\n				<input type=\"hidden\" name=\"updatelottery\" id=\"updatelottery\" value=\"1\" />\r\n          ");
	int lotteryoption__loop__id=0;
	foreach(LotteryOption lotteryoption in PTLottery.GetLotteryOptionList(topicid))
	{
		lotteryoption__loop__id++;
	...
	templateBuilder.Append(" name=\"PollItem\">\r\n              <input type=\"hidden\" id=\"pollitemid\"  name=\"pollitemid\" value=\"");
	templateBuilder.Append(lotteryoption.OptionName.ToString().Trim());
	templateBuilder.Append("\" class=\"txt\" tabindex=\"1\" />\r\n              <input type=\"radio\" id=\"lotterywinid\"  name=\"lotterywinid\" value=\"");
	...
	templateBuilder.Append("\r\n				</div>\r\n				<p style=\"color:red\">请再次确认，在此填入结果项目内容：<br/><input id=\"lotterywinname\" type=\"txt\" name=\"lotterywinname\" value=\"\" style=\"width:340px;\" /></p>\r\n				<br/>\r\n				<p style=\"color:green\"><b>提交后将直接派发彩金，不能修改！请务必保证填写正确！！！</b></p>\r\n			</div>\r\n			<div class=\"sadd z\">\r\n			  <p class=\"mbn\"><label for=\"polldatas\">基础发布投注额，由发布者支付<br/>最少1TB，以TB为单位</label>\r\n          <input name=\"basewager\" id=\"basewager\" size=\"5\" disabled=\"disabled\"  value=\"");
	templateBuilder.Append(lotteryinfo.BaseWager.ToString().Trim());
	templateBuilder.Append("\"/>TB \r\n			  </p>\r\n			  <p></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">博彩结束日期</label>\r\n					<input name=\"enddatetime\" type=\"text\" id=\"enddatetime\"  disabled=\"disabled\" size=\"10\" value=\"");
	templateBuilder.Append(lotteryinfo.EndTime.Year.ToString().Trim());
	templateBuilder.Append("-");
	templateBuilder.Append(lotteryinfo.EndTime.Month.ToString().Trim());
	templateBuilder.Append("-");
	...
	templateBuilder.Append("-");
	templateBuilder.Append(lotteryinfo.EndTime.Day.ToString().Trim());
	templateBuilder.Append("\"/>\r\n					<input type=\"hidden\" name=\"cal_enddate\" id=\"cal_enddate\" size=\"10\"  value=\"\"/>\r\n				</p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">博彩结束时间</label>\r\n          <input name=\"cal_endtimehour\" id=\"cal_endtimehour\" size=\"5\"  disabled=\"disabled\"  value=\"");
	templateBuilder.Append(lotteryinfo.EndTime.Hour.ToString().Trim());
	templateBuilder.Append("\"/>时\r\n          <input name=\"cal_endtimemins\" id=\"cal_endtimemins\" size=\"5\"  disabled=\"disabled\"  value=\"");
	templateBuilder.Append(lotteryinfo.EndTime.Minute.ToString().Trim());
	templateBuilder.Append("\"/>分\r\n          <input name=\"createlottery\" type=\"hidden\" id=\"createlottery\" value=\"1\" />\r\n				</p>\r\n				");string formatstr="0.00";
	templateBuilder.Append("\r\n				<p class=\"mbn\"><label for=\"polldatas\" style=\"color:red\"><b>发布【必须】先联系版主【许可】！删贴流量不退！</b></label></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">胜出彩金池 = 所有输者的投注额 + 基础发布投注</label></p>\r\n				<p class=\"mbn\"><label for=\"polldatas\">胜出彩金池分配：");
	templateBuilder.Append((PTLottery.WAGER_RETURN_RATIO*100).ToString(formatstr).ToString().Trim());
