...
namespace Discuz.Web
{
    ...
    public class poll : PageBase
    {
        ...
        protected override void ShowPage()
        {
            ...
            if (userid > 0 && !Polls.AllowVote(topicid, username))
            {
                AddErrLine("你已经投过票");
                return;
            }
            ...
            if (userid < 1)  ForumUtils.WriteCookie("dnt_polled", string.Format("{0},{1}", (userid > 0 ? "" : ForumUtils.GetCookie("dnt_polled")), topic.Tid));
