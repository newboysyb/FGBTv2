<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.showseedfile" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n	    <div id=\"floatlayout_topicadmin\">\r\n          <h3 class=\"flb\">\r\n            <em id=\"return_emailfriend\">种子包含文件列表</em>\r\n            <span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('showseedfile");
	...
	templateBuilder.Append("\r\n              </em>\r\n          </h3>\r\n          <div class=\"PrivateBTInfoFileListBorder\" id=\"PrivateBTInfoListBorder_showseedfile");
	templateBuilder.Append(seedid.ToString());
	templateBuilder.Append("\">\r\n              <div class=\"PrivateBTInfoListBorder2\" id=\"PrivateBTInfoListBorder2_showseedfile");
	templateBuilder.Append(seedid.ToString());
	templateBuilder.Append("\">\r\n                 <!--  列表开始 -->\r\n                 <table class=\"PrivateBTFileListTable\">\r\n                     <tr class=\"PrivateBTFileListTitle\">\r\n                        <td width=\"100px\">文件大小</td>\r\n                        <td width=\"100px\" class=\"PrivateBTInfoListR\">文件类型</td>\r\n                        <td align=\"left\">路径/文件名</td>\r\n                     </tr>\r\n                     ");
	if (seedfilelist.Rows.Count==0)
	{

	templateBuilder.Append("<tr class=\"PrivateBTFileList\"><td colspan=\"3\" align=\"left\">未能查找到该种子包含文件信息，请下载种子查看</td></tr>");
	}	//end if


	int seedfile__loop__id=0;
	foreach(DataRow seedfile in seedfilelist.Rows)
	{
		seedfile__loop__id++;

	templateBuilder.Append("\r\n                     <tr class=\"PrivateBTFileList\">\r\n                        <td>" + seedfile["size"].ToString().Trim() + "</td>\r\n                        <td class=\"PrivateBTInfoListR\">" + seedfile["filetype"].ToString().Trim() + "</td>\r\n                        <td align=\"left\">" + seedfile["filename"].ToString().Trim() + "</td>\r\n                     </tr>\r\n                     ");
	}	//end loop
