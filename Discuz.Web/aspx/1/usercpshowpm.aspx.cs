...
namespace Discuz.Web
{
    ...
    public class usercpshowpm : UserCpPage
    {
        ...
        protected override void ShowPage()
        {
            ...
            //此处不应该进行htmldecode操作，否则将导致填写的各种理由被HTML编码，称为安全漏洞
            ...
            if (messageinfo != null && (messageinfo.Msgtoid == userid || messageinfo.Msgfromid == userid))
            {
                ...
                {
                    ispost = true;
                    if (PrivateMessages.DeletePrivateMessage(userid, pmid, ipaddress) < 1)
                    {
                ...
                else
                {
                    ...
                    if (messageinfo.New == 1 && messageinfo.Folder == 0)
                    {
                        ...
                        if (oluserinfo.Newpms > 0) oluserinfo.Newpms -= 1; //【BT修改】查看短消息的页面，当前显示的PM数值即减1
                    }
                }
                ...
                msgfromid = messageinfo.Msgfromid;
