...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:12.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:12. 
	*/
	...
	templateBuilder.Append("\r\n            <form action=\"search.aspx?type=seed\" autocomplete=\"off\" name=\"postpm\" method=\"post\" class=\"searchform\">\r\n        ");
	}
	else if (type=="topic")
	{

	templateBuilder.Append("  \r\n            <form action=\"search.aspx?type=topic\" autocomplete=\"off\" name=\"postpm\" method=\"post\" class=\"searchform\">\r\n        ");
	}
	else if (type=="spacepost")
	{

	templateBuilder.Append(" \r\n            <form action=\"search.aspx?type=spacepost\" autocomplete=\"off\" name=\"postpm\" method=\"post\" class=\"searchform\">\r\n        ");
	}
	else if (type=="album")
	{

	templateBuilder.Append(" \r\n            <form action=\"search.aspx?type=album\" autocomplete=\"off\" name=\"postpm\" method=\"post\" class=\"searchform\">\r\n        ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n            \r\n            <table cellspacing=\"0\" cellpadding=\"0\" class=\"mbm\" id=\"tpsch\">\r\n            <tbody>\r\n                <tr>\r\n                <td><h1><a title=\"未来花园BT\" href=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("index.aspx\"><img alt=\"未来花园BT\" src=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("templates/default/images/logo.png\"></a></h1></td>\r\n                <td>\r\n                    <ul class=\"tb cl\">\r\n                        \r\n                            ");
	if (type=="seed")
	{

	templateBuilder.Append("\r\n                                <li id=\"seedli\"><a id=\"seedlink\" href=\"search.aspx?type=seed&keyword=");
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"font-weight:700;text-decoration:none\">种子</span></a></li>\r\n                            ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                                <li id=\"seedli\"><a id=\"seedlink\" href=\"search.aspx?type=seed&keyword=");
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"text-decoration:underline;color:#666\">种子</span></a></li>\r\n                            ");
	}	//end if
	...
	templateBuilder.Append("\r\n                                <li id=\"forumli\"><a id=\"forumink\" href=\"search.aspx?type=topic&keyword=");
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"font-weight:700;text-decoration:none\">帖子</span></a></li>\r\n                            ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                                <li id=\"forumli\"><a id=\"forumink\" href=\"search.aspx?type=topic&keyword=");
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"text-decoration:underline;color:#666\">帖子</span></a></li>\r\n                            ");
	}	//end if
	...
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"font-weight:700;text-decoration:none\">空间</span></a></li>\r\n                            ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                                <li id=\"spaceli\"><a id=\"spacelink\" href=\"search.aspx?type=spacepost&keyword=");
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"text-decoration:underline;color:#666\">空间</span></a></li>\r\n                            ");
	}	//end if
	...
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"font-weight:700;text-decoration:none\">相册</span></a></li>\r\n                            ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                                <li id=\"albumli\"><a id=\"albumlink\" href=\"search.aspx?type=album&keyword=");
	templateBuilder.Append(keyword.ToString());
	templateBuilder.Append("&searchsubmit=1\"><span style=\"text-decoration:underline;color:#666\">相册</span></a></li>\r\n                            ");
	}	//end if
	...
	templateBuilder.Append("\r\n                                    <label><a href=\"showseeds.aspx\">高级</a>\r\n                                ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n            <div class=\"search\">\r\n                <form action=\"\" name=\"postpm\" autocomplete=\"off\" method=\"post\" class=\"searchform\">\r\n                    <table cellspacing=\"0\" cellpadding=\"0\">\r\n                    <tbody>\r\n                    <tr>\r\n                        <td class=\"s_logo\"><h1 class=\"mtw ptw\"><a title=\"未来花园BT\" href=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("index.aspx\"><img alt=\"未来花园BT\" src=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("templates/default/images/logo.png\"></a></h1></td>\r\n                        <td colspan=\"2\"></td>\r\n                    </tr>\r\n                    <tr>\r\n                        <td width=\"400\" class=\"hm xs2\" style=\"text-align:left\">\r\n                            ");
	if (type=="seed")
	{

	templateBuilder.Append("\r\n                                <span style=\"font-weight:700;text-decoration:none\">种子</span>&nbsp;&nbsp;\r\n                            ");
	}
	else
	{

	templateBuilder.Append("\r\n                                <a id=\"seedlink\" href=\"search.aspx?type=seed\"><span style=\"text-decoration:underline;color:#666\">种子</span></a>&nbsp;&nbsp;\r\n                            ");
	}	//end if
	...
	templateBuilder.Append("\r\n                                <span style=\"font-weight:700;text-decoration:none\">帖子</span>&nbsp;&nbsp;\r\n                            ");
	}
	else
	{

	templateBuilder.Append("\r\n                                <a id=\"forumink\" href=\"search.aspx?type=topic\"><span style=\"text-decoration:underline;color:#666\">帖子</span></a>&nbsp;&nbsp;\r\n                            ");
	}	//end if
	...
	templateBuilder.Append("\r\n                                <span style=\"font-weight:700;text-decoration:none\">空间</span>&nbsp;&nbsp;\r\n                            ");
	}
	else
	{

	templateBuilder.Append("\r\n                                <a id=\"spacelink\" href=\"search.aspx?type=spacepost\"><span style=\"text-decoration:underline;color:#666\">空间</span></a>&nbsp;&nbsp;\r\n                            ");
	}	//end if
	...
	templateBuilder.Append("\r\n                                <span style=\"font-weight:700;text-decoration:none\">相册</span>&nbsp;&nbsp;\r\n                            ");
	}
	else
	{

	templateBuilder.Append("\r\n                                <a id=\"albumlink\" href=\"search.aspx?type=album\"><span style=\"text-decoration:underline;color:#666\">相册</span></a>&nbsp;&nbsp;\r\n                            ");
	}	//end if
	...
	templateBuilder.Append(Caches.GetForumListBoxOptionsCache(usergroupid).ToString().Trim());
	...
	templateBuilder.Append("index.aspx\"><img alt=\"未来花园BT\" src=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("templates/default/images/logo.png\"></a></h1></td>\r\n                            <td>\r\n                                <ul class=\"tb cl\">\r\n                                    <li id=\"seedli\"><a href=\"search.aspx?type=seed\">种子</a></li>\r\n                                    <li id=\"forumli\" class=\"a\"><a href=\"search.aspx?type=topic\">论坛</a></li>\r\n                                    ");
	if (config.Enablespace==1)
	{
