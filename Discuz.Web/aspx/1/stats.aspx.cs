...
namespace Discuz.Web
{
    ...
    public class stats : PageBase
    {
        ...
        public PrivateBTAllStats Default_Basic;
        public PrivateBTAllStats Default_Forum;
        public PrivateBTAllStats Default_Traffic;
        public PrivateBTAllStats Default_MonthTraffic;
        public PrivateBTAllStats Views_Week;
        public PrivateBTAllStats Views_Hour;
        public PrivateBTAllStats Client_OS;
        public PrivateBTAllStats Client_Browser;
        public PrivateBTAllStats Posts_Month;
        public PrivateBTAllStats Posts_Day;
        public PrivateBTAllStats ForumsRank;
        public PrivateBTAllStats TopicsRank;
        public PrivateBTAllStats PostsRank;
        public PrivateBTAllStats CreditsRank;
        public PrivateBTAllStats OnlineTimeRank;
        public PrivateBTAllStats UpDownRank;
        public PrivateBTAllStats RatioRank;
        public PrivateBTServerStats btstatspk;
        public PrivateBTServerStats btstats;
        ...
        protected override void ShowPage()
        {
            ...
            switch (type)
            {
                case "views":
                    {
                        Views_Week = PrivateBT.GetAllStatsHTML("Views_Week");
                        Views_Hour = PrivateBT.GetAllStatsHTML("Views_Hour");
                        break;
                    }

                case "client":
                    {
                        Client_OS = PrivateBT.GetAllStatsHTML("Client_OS");
                        Client_Browser = PrivateBT.GetAllStatsHTML("Client_Browser");
                        break;
                    }
                case "posts":
                    {
                        Posts_Month = PrivateBT.GetAllStatsHTML("Posts_Month");
                        Posts_Day = PrivateBT.GetAllStatsHTML("Posts_Day");
                        break;
                    }
                case "forumsrank":
                    {
                        ForumsRank = PrivateBT.GetAllStatsHTML("ForumsRank");
                        break;
                    }

                case "topicsrank":
                    {
                        TopicsRank = PrivateBT.GetAllStatsHTML("TopicsRank");
                        break;
                    }

                case "postsrank":
                    {
                        PostsRank = PrivateBT.GetAllStatsHTML("PostsRank", userid);
                        break;
                    }
                case "creditsrank":
                    {
                        CreditsRank = PrivateBT.GetAllStatsHTML("CreditsRank", userid);
                        break;
                    }
                case "trade":
                    {
                ...
                case "onlinetime":
                    {
                        OnlineTimeRank = PrivateBT.GetAllStatsHTML("OnlineTimeRank", userid);
                        break;
                    }
                case "team":
                    {
                ...
                case "updown":
                    {
                        UpDownRank = PrivateBT.GetAllStatsHTML("UpDownRank", userid);
                        break;
                    }
                case "ratio":
                    {
                        RatioRank = PrivateBT.GetAllStatsHTML("RatioRank", userid);
                        break;
                    }
                case "":
                    {
                        //获取BT统计信息
                        btstatspk = PrivateBT.GetServerStats(2);
                        btstats = PrivateBT.GetServerStats();

                        Default_Basic = PrivateBT.GetAllStatsHTML("Default_Basic");
                        Default_Forum = PrivateBT.GetAllStatsHTML("Default_Forum");
                        Default_Traffic = PrivateBT.GetAllStatsHTML("Default_Traffic");
                        Default_MonthTraffic = PrivateBT.GetAllStatsHTML("Default_MonthTraffic");
                        break;
                    }
        ...
        private void GetOnlinetime()
        {
            ...
            totalonlinerank = Stats.GetUserRankHtml(total, "onlinetime", maxrows, userid);
            thismonthonlinerank = Stats.GetUserRankHtml(thismonth, "onlinetime", maxrows, userid);
        ...
        private void GetCreditsRank()
        {
            ...
            creditsrank = Stats.GetUserRankHtml(credits, "credits", maxrows, userid);
            extcreditsrank1 = Stats.GetUserRankHtml(extendedcredits[0], "extcredits1", maxrows, userid);
            extcreditsrank2 = Stats.GetUserRankHtml(extendedcredits[1], "extcredits2", maxrows, userid);
            extcreditsrank3 = Stats.GetUserRankHtml(extendedcredits[2], "extcredits3", maxrows, userid);
            extcreditsrank4 = Stats.GetUserRankHtml(extendedcredits[3], "extcredits4", maxrows, userid);
            extcreditsrank5 = Stats.GetUserRankHtml(extendedcredits[4], "extcredits5", maxrows, userid);
            extcreditsrank6 = Stats.GetUserRankHtml(extendedcredits[5], "extcredits6", maxrows, userid);
            extcreditsrank7 = Stats.GetUserRankHtml(extendedcredits[6], "extcredits7", maxrows, userid);
            extcreditsrank8 = Stats.GetUserRankHtml(extendedcredits[7], "extcredits8", maxrows, userid);
        ...
        private void GetPostsRank()
        {
            ...
            postsrank = Stats.GetUserRankHtml(posts, "posts", maxrows, userid);
            digestpostsrank = Stats.GetUserRankHtml(digestposts, "digestposts", maxrows, userid);
            thismonthpostsrank = Stats.GetUserRankHtml(thismonth, "thismonth", maxrows, userid);
            todaypostsrank = Stats.GetUserRankHtml(today, "today", maxrows, userid);
