...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:09.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:09. 
	*/
	...
	templateBuilder.Append("条</em> <em>其中新通知:");
	templateBuilder.Append(newnoticecount.ToString());
	...
	templateBuilder.Append("\r\n                    </dd>\r\n					<dt>\r\n						");	string postdatetime = ForumUtils.ConvertDateTimeWithColor(noticeinfo.Postdatetime);
	...
	templateBuilder.Append(" <span class=\"PrivateBTNewNotice\"> 新通知 New! </span> ");
	}	//end if
	...
	templateBuilder.Append("onclick=\"javascript:PrivateBTMarkNotice('");
	templateBuilder.Append(noticeinfo.Nid.ToString().Trim());
	templateBuilder.Append("')\"");
	}	//end if
