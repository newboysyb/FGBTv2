<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.showseedpeerhistory" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n	    <div id=\"floatlayout_topicadmin\">\r\n          <h3 class=\"flb\">\r\n            <em id=\"return_emailfriend\">种子节点列表历史记录</em>\r\n            <span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('showseedpeerhistory");
	...
	templateBuilder.Append("\r\n              </em>\r\n          </h3>\r\n          <div class=\"PrivateBTInfoFileListBorder\" id=\"PrivateBTInfoListBorder_showseedpeerhistory");
	templateBuilder.Append(seedid.ToString());
	templateBuilder.Append("\">\r\n              <div class=\"PrivateBTInfoListBorder2\" id=\"PrivateBTInfoListBorder2_showseedpeerhistory");
	templateBuilder.Append(seedid.ToString());
	templateBuilder.Append("\">\r\n                     <!--  列表开始 -->   \r\n                         ");
	if (userid<3)
	{

	templateBuilder.Append("  \r\n                         <table class=\"PrivateBTPeerListTable\">\r\n                           <tr class=\"PrivateBTPeerListTitle\">\r\n                                        <td width=\"10%\">用户名</td>\r\n                                        <td width=\"10%\">共享率</td>\r\n                                        <td width=\"10%\">上传</td>\r\n                                        <td width=\"10%\">下载</td>\r\n                                        <td width=\"20%\">首次更新</td>\r\n                                        <td width=\"20%\">完成时间</td>\r\n                                        <td width=\"20%\" class=\"PrivateBTInfoListR\">最后更新</td>\r\n                           </tr>\r\n                           ");
	if (peerlist.Rows.Count==0)
	{

	templateBuilder.Append("<tr class=\"PrivateBTPeerList\"><td colspan=\"6\" align=\"left\">该种子没有历史节点记录</td></tr>");
	}	//end if
	...
	templateBuilder.Append("\r\n                           <tr class=\"PrivateBTPeerList\">\r\n                              <td><a class=\"PrivateBTLink_black\" href=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("userinfo-" + peer["uid"].ToString().Trim() + ".aspx\">" + peer["username"].ToString().Trim() + "</a></td>\r\n                              <td>" + peer["rat"].ToString().Trim() + "</td>\r\n                              <td>" + peer["up"].ToString().Trim() + "</td>\r\n                              <td>" + peer["down"].ToString().Trim() + "</td>\r\n                              <td><span title = \"" + peer["firstipv4"].ToString().Trim() + " - " + peer["firstipv6"].ToString().Trim() + "\">" + peer["firstupdate"].ToString().Trim() + "</span></td>\r\n                              <td>" + peer["finishtime"].ToString().Trim() + "</td>\r\n                              <td class=\"PrivateBTInfoListR\"><span title = \"" + peer["lastipv4"].ToString().Trim() + " - " + peer["lastipv6"].ToString().Trim() + "\">" + peer["lastupdate"].ToString().Trim() + "</span></td>\r\n                           </tr>\r\n                           ");
	}	//end loop
