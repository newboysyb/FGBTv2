<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpinvitation" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>购买邀请</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("\r\n        <form action=\"\" method=\"post\" id=\"postform\">\r\n        <table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"共享率保护\">\r\n          <caption>\r\n            <div class=\"hintinfo\" style=\"margin:0;\">\r\n					    <p>邀请码有效期为14天！当前邀请码的价格为");
	templateBuilder.Append(PTTools.Upload2Str(inviteprice).ToString().Trim());
	templateBuilder.Append("上传流量/个，您所拥有的上传现在可以购买");
	templateBuilder.Append(maxnumber.ToString());
	templateBuilder.Append("个邀请，您可以将金币转换为上传后再购买</p>\r\n            </div>\r\n            <br/>\r\n            <div class=\"hintinfo\" style=\"margin:0;\">\r\n              <p>");
	templateBuilder.Append(alertmessage.ToString());
	templateBuilder.Append("</p>\r\n            </div>\r\n          </caption>\r\n          <tbody>\r\n          <tr>\r\n              <th>当前帐户:</th>\r\n              <td>\r\n                  ");
	...
	templateBuilder.Append(PTTools.Upload2Str(user.Extcredits3).ToString().Trim());
	templateBuilder.Append("</em>&nbsp;&nbsp;\r\n                  ");
	}	//end if
	...
	templateBuilder.Append(PTTools.Upload2Str(user.Extcredits4).ToString().Trim());
	templateBuilder.Append("</em>&nbsp;&nbsp;\r\n                  ");
	}	//end if
