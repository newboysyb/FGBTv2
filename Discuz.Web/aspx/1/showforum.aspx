...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:39.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:39. 
	*/
	...
	templateBuilder.Append("\r\n    <form id=\"forum_quicksearch_form\" name=\"forum_quicksearch_form\" method=\"post\" action=\"search.aspx?advsearch=1\"  style=\"padding-top:2px;\">\r\n        <input type=\"text\" id=\"forum_quicksearch_textinput\" name=\"keyword\" value=\"板块搜索\" onblur=\"javascript:if(this.value=='') this.value='板块搜索';\" onclick=\"javascript:if(this.value=='板块搜索') this.value='';\" class=\"txt\"/>\r\n        <input type=\"text\" name=\"searchsubmit\" value=\"1\" style=\"display:none;\"/>\r\n        <input type=\"submit\" name=\"submit\" value=\"\" class=\"btnsearch\"/>\r\n        <input type=\"text\" id=\"searchforumid\" name=\"searchforumid\" value=\"");
	templateBuilder.Append(forum.Fid.ToString().Trim());
	...
	if (64==(forum.Allowpostspecial&64))
	{

	templateBuilder.Append("\r\n				<td class=\"icon\" style=\"width:70px;\">&nbsp;</td>\r\n				<td class=\"icon\" style=\"width:60px;\">&nbsp;</td>\r\n				<td class=\"icon\" style=\"width:70px;\">&nbsp;</td>\r\n            ");
...
//特殊帖图标
	...
	if (toptopic.Special==64)
	{

	templateBuilder.Append("\r\n							<img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/exchange.gif\" alt=\"文件交换\"/>\r\n						");
	}	//end if


	if (toptopic.Special==128)
	{

	templateBuilder.Append("\r\n							<img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/lottery.gif\" alt=\"博彩\"/>\r\n						");
	}	//end if
	...
	templateBuilder.Append("</cite>\r\n						");	string ttpdtime = ForumUtils.ConvertDateTimeWithColor(toptopic.Postdatetime);
	
	templateBuilder.Append("\r\n						<em title=\"");	templateBuilder.Append(TypeConverter.StrToDateTime(toptopic.Postdatetime).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\">");
	...
	templateBuilder.Append("\r\n						</cite>\r\n						<em title=\"");	templateBuilder.Append(TypeConverter.StrToDateTime(toptopic.Lastpost).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\"><a href=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("showtopic.aspx?topicid=");
	templateBuilder.Append(toptopic.Tid.ToString().Trim());
...
/*特殊帖图标*/
	...
	if (64==(forum.Allowpostspecial&64))
	{
						...
						string dis_size = abtseedlist[displaycount].Dis_Size;
						string dis_filecount = abtseedlist[displaycount].FileCount.ToString();
						string dis_uploads = abtseedlist[displaycount].Upload.ToString();
						string dis_upload = abtseedlist[displaycount].Dis_Upload;
						string dis_download = abtseedlist[displaycount].Download.ToString();
						string dis_finished = abtseedlist[displaycount].Finished.ToString();
						string dis_live = abtseedlist[displaycount].Dis_Live;
						
						if(abtseedlist[displaycount].FileCount==0)
						{
	              dis_size = "";dis_filecount = "";dis_uploads = "";dis_upload = "";dis_download = ""; dis_finished = "";dis_live = "";
						}
						
	templateBuilder.Append("\r\n					\r\n          <td class=\"PrivateBTSeedListFile\" title=\"文件总大小 ");
	templateBuilder.Append(dis_size.ToString());
	templateBuilder.Append("，种子包含的文件数 ");
	templateBuilder.Append(dis_filecount.ToString());
	templateBuilder.Append("\">\r\n             <span class=\"PrivateBTSeedListSize\">");
	templateBuilder.Append(dis_size.ToString());
	templateBuilder.Append("</span><br/>\r\n             ");
	templateBuilder.Append(dis_filecount.ToString());
	templateBuilder.Append("</td>\r\n          <td class=\"PrivateBTSeedListSeeds\" title=\"在线种子数 ");
	templateBuilder.Append(dis_uploads.ToString());
	templateBuilder.Append("，正在下载数 ");
	templateBuilder.Append(dis_download.ToString());
	templateBuilder.Append("\" >\r\n            ");
	templateBuilder.Append(dis_upload.ToString());
	templateBuilder.Append("<br/>\r\n            <span class=\"PrivateBTSeedListDown\">");
	templateBuilder.Append(dis_download.ToString());
	templateBuilder.Append("</span></td>\r\n          <td class=\"PrivateBTSeedListFinished\" title=\"完成数 ");
	templateBuilder.Append(dis_finished.ToString());
	templateBuilder.Append("，最后活动距今");
	templateBuilder.Append(dis_live.ToString());
	templateBuilder.Append("\">\r\n            ");
	templateBuilder.Append(dis_finished.ToString());
...
int dis_aid = abtseedlist[displaycount].Aid;

	if (dis_aid>0)
	{

	templateBuilder.Append("\r\n                  &nbsp;<a href=\"downloadseed.aspx?abtseed=1&seedid=");
	templateBuilder.Append(dis_aid.ToString());
	...
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/bt/download.gif\" title=\"注意：对于每个种子，只有最后一次下载的种子有效\"/>\r\n                  </a>&nbsp;\r\n                 ");
	}	//end if
	...
	templateBuilder.Append("\r\n						</cite>\r\n						");	string tpdtime = ForumUtils.ConvertDateTimeWithColor(topic.Postdatetime);
	
	templateBuilder.Append("\r\n						<em title=\"");	templateBuilder.Append(TypeConverter.StrToDateTime(topic.Postdatetime).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\">");
	...
	templateBuilder.Append("\r\n						</cite>\r\n						<em title=\"");	templateBuilder.Append(TypeConverter.StrToDateTime(topic.Lastpost).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\"><a href=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("showtopic.aspx?topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	...
	templateBuilder.Append("\r\n                  <a href=\"javascript:;\" onclick=\"modthreads(4,'closebonus');return false;\">结束悬赏</a>\r\n                  ");
	}	//end if
