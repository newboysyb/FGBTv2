...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2015/1/7 16:52:36.
		本页面代码由Discuz!NT模板引擎生成于 2015/1/7 16:52:36. 
	*/
	...
	templateBuilder.Append("\" name=\"pm_");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("\" class=\"txt\" value=\"符合版规\"> &nbsp; \r\n							<select onchange=\"$('pm_");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("').value=this.value;\" style=\"margin: 0px;\">\r\n							<option value=\"\">无</option>\r\n							<option value=\"\">--------</option>\r\n							<option value=\"不符合版规，转移到品茶亭\">不符合版规，转移到品茶亭</option>\r\n							<option value=\"广告/SPAM\">广告/SPAM</option>\r\n							<option value=\"恶意灌水\">恶意灌水</option>\r\n							<option value=\"违规内容\">违规内容</option>\r\n							<option value=\"文不对题\">文不对题</option>\r\n							<option value=\"重复发帖\">重复发帖</option>\r\n							<option></option>\r\n							<option value=\"我很赞同\">我很赞同</option>\r\n							<option value=\"精品文章\">精品文章</option>\r\n							<option value=\"原创内容\">原创内容</option>\r\n							</select>\r\n							<a href=\"###\" id=\"pass_");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	...
	templateBuilder.Append("\" id=\"mod_");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("\" onclick=\"_auditpost('passtoforum25topic',");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append(",$('pm_");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("').value)\">通过到品茶亭</a>\r\n							</cite>\r\n							<input id=\"audittopicid\" name=\"audittopicid\" type=\"checkbox\" value=\"");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	...
	templateBuilder.Append(operation.ToString());
	templateBuilder.Append("\" />\r\n			<table cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\" summary=\"论坛版块选择\">\r\n			<tbody>\r\n			<tr>\r\n				<th width=\"60\">说明</th>\r\n				<td>\r\n					可用的Discuz！代码：\r\n					<span style=\"border:#C00 2px solid;color:#C00; font-size:16px; background-color:#FF0\"><b>[alert1]警示标志1[/alert1]，</b></span>\r\n					<span style=\"border:#00C 2px solid;color:#00C; font-size:16px; background-color:#AFF\"><b>[alert2]警示标志2[/alert2]，</b></span>\r\n					<span style=\"border:#090 2px solid;color:#090; font-size:16px; background-color:#BF9\"><b>[alert3]警示标志3[/alert3]，</b></span>\r\n					，图片代码，字体代码，对齐代码，段落代码，超链接\r\n				</td>\r\n			</tr>\r\n			<tr>\r\n				<th width=\"60\">版块</th>\r\n				<td>\r\n					<div class=\"ftid\">\r\n					<select style=\"width:150px;\" name=\"forumid\" id=\"forumid\" onchange=\"location.href='modcp.aspx?operation=editforum&forumid='+jQuery('#forumid option:selected').val()\">\r\n						<option value=\"0\" disabled=\"true\">全部</option>\r\n						");
	templateBuilder.Append(forumliststr.ToString());
	templateBuilder.Append("\r\n					</select>\r\n					</div>\r\n				</td>\r\n			</tr>\r\n			</tbody>\r\n			</table>\r\n		</form>\r\n		");
	if (forumid!=0)
	{
	...
	if (PrivateBT.Forum2Type(foruminfo.Fid)>0)
	{

	templateBuilder.Append("发种提示");
	}
	else
	{

	templateBuilder.Append("版块简介");
	}	//end if
	...
	templateBuilder.Append("\r\n                <input id=\"forumdescriptionisnothtml_radio\" name=\"forumdescriptionishtml_radio\" value=\"0\" type=\"radio\" ");
	if (foruminfo.DescriptionIsHTML==0)
	{

	templateBuilder.Append("checked=\"checked\"");
	}	//end if

	templateBuilder.Append(">UBB代码发种提示 [ 推荐 ] </input>\r\n                <input id=\"forumdescriptionishtml_radio\" name=\"forumdescriptionishtml_radio\" value=\"1\" type=\"radio\" ");
	if (foruminfo.DescriptionIsHTML>0)
	{
	...
	templateBuilder.Append(">HTML代码发种提示<b> [ 不推荐：每次提交均需要admin审核后方可生效，非特殊请勿使用，如修改请PM @admin审核 ] </b></input>\r\n                <br/>\r\n            ");
	}
	else
	{

	templateBuilder.Append("\r\n                <input id=\"forumdescriptionisnothtml_radio\" name=\"forumdescriptionishtml_radio\" value=\"0\" type=\"radio\" checked=\"checked\">UBB代码板块简介 [ 推荐 ] </input>\r\n                <input id=\"forumdescriptionishtml_radio\" name=\"forumdescriptionishtml_radio\" value=\"1\" type=\"radio\" disabled=\"disabled\" >HTML代码板块简介 [ 不可用 ] </input>\r\n                <br/>\r\n            ");
	}	//end if
	...
	templateBuilder.Append(seditorid.ToString());
	templateBuilder.Append("', 'url')\">Link</a>\r\n                            </div>\r\n                    </div>\r\n					<textarea id=\"descriptionmessage\" name=\"descriptionmessage\" rows=\"8\"class=\"txtarea\" style=\"width:100%;padding:0\" >");
	templateBuilder.Append(foruminfo.DescriptionUBB.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n					");
	}
	else
	{

	templateBuilder.Append("\r\n					<textarea id=\"descriptionmessage\" name=\"descriptionmessage\" rows=\"8\" cols=\"80\" disabled readonly class=\"txtarea\" style=\"width:100%;padding:0\">\r\n					");
	templateBuilder.Append(foruminfo.DescriptionUBB.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n					");
	}	//end if
	...
	templateBuilder.Append("目前生效的板块发种提示：");
	}
	else
	{

	templateBuilder.Append("目前生效的板块板块简介：");
	}	//end if
	...
	templateBuilder.Append("<b> [ UBB已经自动转换为HTML ] </b>");
	}
	else if (foruminfo.DescriptionIsHTML==1)
	{

	templateBuilder.Append("<b> [ HTML已审核通过 ] </b>");
	}
	else if (foruminfo.DescriptionIsHTML==2)
	{

	templateBuilder.Append("<b> [ HTML等待审核中... ] </b>");
	}	//end if

	templateBuilder.Append("<br/>\r\n					<textarea id=\"descriptionmessageshow\" name=\"descriptionmessageshow\" rows=\"8\" cols=\"80\" readonly class=\"txtarea\" style=\"width:100%;padding:0;background-color:#E5EDF2;\">\r\n					");
	templateBuilder.Append(Utils.HtmlEncode(foruminfo.Description).ToString().Trim());
	templateBuilder.Append("</textarea>\r\n				</td>\r\n			</tr>\r\n			<tr>\r\n                <th valign=\"top\">版头</th>\r\n				<td>\r\n					<div id=\"rulespreview\" style=\"display:none\" class=\"rulespreview\"></div>\r\n              <input id=\"forumrulesisnothtml_radio\" name=\"forumrulesishtml_radio\" value=\"0\" type=\"radio\" ");
	if (foruminfo.RulesIsHTML==0)
	{

	templateBuilder.Append("checked=\"checked\"");
	}	//end if

	templateBuilder.Append(">UBB代码版头 [ 推荐 ] </input>\r\n              <input id=\"forumrulesishtml_radio\" name=\"forumrulesishtml_radio\" value=\"1\" type=\"radio\" ");
	if (foruminfo.RulesIsHTML>0)
	{
	...
	templateBuilder.Append(">HTML代码版头<b> [ 不推荐：每次提交均需要admin审核后方可生效，非特殊请勿使用，如修改请PM @admin审核 ] </b></input>\r\n              <br/>\r\n				");
	if (alloweditrules)
	{
	...
	templateBuilder.Append("url\" onclick=\"seditor_menu('");
	templateBuilder.Append(seditorid.ToString());
	templateBuilder.Append("', 'url')\">Link</a>\r\n							</div>\r\n					</div>\r\n					<textarea id=\"rulesmessage\" name=\"rulesmessage\" rows=\"8\" cols=\"80\" class=\"txtarea\" style=\"width:100%;padding:0\">");
	templateBuilder.Append(foruminfo.RulesUBB.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n					");
	}
	else
	{

	templateBuilder.Append("\r\n            <textarea id=\"rulesmessage\" name=\"rulesmessage\" rows=\"8\" cols=\"80\" disabled readonly class=\"txtarea\" style=\"width:100%;padding:0\">\r\n            ");
	templateBuilder.Append(foruminfo.RulesUBB.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n					");
	}	//end if
	...
	else if (foruminfo.RulesIsHTML==1)
	{

	templateBuilder.Append("<b> [ HTML已审核通过 ] </b>");
	}
	else if (foruminfo.RulesIsHTML==2)
	{

	templateBuilder.Append("<b> [ HTML等待审核中... ] </b>");
	}	//end if

	templateBuilder.Append("<br/>\r\n					  <textarea id=\"rulesmessageshow\" name=\"rulesmessageshow\" rows=\"8\" cols=\"80\" readonly class=\"txtarea\" style=\"width:100%;padding:0;background-color:#E5EDF2;\">\r\n            <b>");
	templateBuilder.Append(Utils.HtmlEncode(foruminfo.Rules).ToString().Trim());
	templateBuilder.Append("</b></textarea>\r\n				</td>\r\n			</tr>\r\n			<tr>\r\n        <th></th><td>\r\n            <div class=\"lpsw\" style=\"position: relative;margin-bottom:10px;\">\r\n              ");
