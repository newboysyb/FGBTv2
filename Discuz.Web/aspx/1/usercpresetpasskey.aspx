<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpresetpasskey" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>重置用户识别码（Passkey）</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("\r\n	<div class=\"uc_main\">\r\n	<div class=\"uc_content\">\r\n		<h1>重置用户识别码（Passkey）</h1>\r\n		");

	if (userid>0)
	{

	templateBuilder.Append("\r\n<ul class=\"f_tab\">\r\n	<li ");
	if (pagename=="usercpratioprotect.aspx")
	{

	templateBuilder.Append("class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpratioprotect.aspx\">共享率保护</a></li>\r\n  <li ");
	if (pagename=="usercpresetpasskey.aspx")
	{

	templateBuilder.Append("class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpresetpasskey.aspx\">重置用户识别码（Passkey）</a></li>\r\n	<li ");
	if (pagename=="usercpresetpeer.aspx")
	{

	templateBuilder.Append("class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpresetpeer.aspx\">重置上传下载列表</a></li>\r\n</ul>\r\n");
	}	//end if
	...
	templateBuilder.Append("\r\n        <form action=\"\" method=\"post\" id=\"postform\">\r\n        <table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"共享率保护\">\r\n          <caption>\r\n            <div class=\"hintinfo\" style=\"margin:0;\">\r\n                <p>重置Passkey之前请仔细阅读以下注意事项</p>\r\n                <p>1.Passkey是进行流量统计的唯一依据，请务必保护好您的Passkey，不要泄露，不要将从本站下载的种子发给别人</p>\r\n                <p>2.生成新的Passkey之后，您需要修改所有正在上传下载种子中的Tracker地址</p>\r\n                <p>操作过程：请先将所有种子停止，然后使用重置Passkey功能，在uTorrent中替换所有种子内的Passkey值，之后再重新开启所有任务</p>\r\n            </div>\r\n          </caption>\r\n          <tbody>\r\n          <tr>\r\n              <th>您当前的Passkey为:</th>\r\n              <td>\r\n                  ");
	templateBuilder.Append(btuserinfo.Passkey.ToString().Trim());
	templateBuilder.Append("<br/>\r\n              </td>\r\n          </tr>\r\n          <tr>\r\n              <th>正在上传的种子数:</th>\r\n              <td>\r\n                  <a href=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("showseeds.aspx?type=all&orderby=0&asc=False&seedstat=0&username=");
	templateBuilder.Append(user.Username.ToString().Trim());
	templateBuilder.Append("&userstat=1\" style=\"color:#09C; font-weight:bold;\"><img src=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/bt/upcount.png\" title=\"正在上传种子数\"/> ");
	templateBuilder.Append(user.UpCount.ToString().Trim());
	templateBuilder.Append("</a><br/>\r\n              </td>\r\n          </tr>\r\n          <tr>\r\n              <th>正在下载的种子数:</th>\r\n              <td>\r\n                  <a href=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("showseeds.aspx?type=all&orderby=0&asc=False&seedstat=0&username=");
	templateBuilder.Append(user.Username.ToString().Trim());
	templateBuilder.Append("&userstat=2\" style=\"color:#F60; font-weight:bold;\"><img src=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/bt/downcount.png\" title=\"正在下载种子数\"/> ");
	templateBuilder.Append(user.DownCount.ToString().Trim());
