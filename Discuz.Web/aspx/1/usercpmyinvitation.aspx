<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpmyinvitation" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>我的邀请码</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("\r\n			</div>\r\n		</div>\r\n				");
	if (invitationlist.Rows.Count>0)
	{

	templateBuilder.Append("	\r\n            <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"datatable\">\r\n              <caption>\r\n                <div class=\"hintinfo\" style=\"margin:0;\">\r\n                    <p>请注意：如果被邀请人因为严重违反论坛相关规定被管理人员禁封，您将受到扣除500G上传的处罚。详情请查看公告区通知</p>\r\n                    <p>请注意：邀请人真实上传达到一定值，您将获得奖励上传，最多可达270G。详情请查看公告区通知</p>\r\n                    <p>请务必只将邀请发放给您信任的人，不要散发给陌生人。</p>\r\n                </div>\r\n                <br/>\r\n              </caption>\r\n              <tr class=\"colplural\">\r\n              <th width=\"10%\">序号</th>\r\n              <th width=\"10%\">邀请码ID</th>\r\n              <th width=\"30%\">邀请码</th>\r\n              <th width=\"20%\">购买时间</th>\r\n							<th width=\"20%\">有效期</th>\r\n							<th width=\"10%\">状态</th>\r\n            </tr>\r\n            ");
	int invitation__loop__id=0;
	foreach(DataRow invitation in invitationlist.Rows)
	{
		invitation__loop__id++;

	templateBuilder.Append("\r\n            <tbody>\r\n            <tr class=\"messagetable\" onmouseover=\"this.className='messagetableon'\" onmouseout=\"this.className='messagetable'\">\r\n                          <td>" + invitation["sn"].ToString().Trim() + "</td>\r\n                          <td>" + invitation["id"].ToString().Trim() + "</td>\r\n                          <td>" + invitation["invitekey"].ToString().Trim() + "</td>\r\n                          <td>" + invitation["buytime"].ToString().Trim() + "</td>\r\n                          <td>" + invitation["valid"].ToString().Trim() + "</td>\r\n                          <td>" + invitation["status"].ToString().Trim() + "</td>\r\n            </tr>\r\n            </tbody>\r\n            ");
	}	//end loop
