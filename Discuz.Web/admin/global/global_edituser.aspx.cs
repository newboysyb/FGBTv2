...
namespace Discuz.Web.Admin
{
    ...
    public partial class edituser : AdminPage
    {
        ...
        private bool AllowEditUser(int managerUId, int targetUId)
        {
            ...
            //uid=1不可更改
            if(targetUId == 1 && managerUId != 1) return false;
        ...
        private void SaveUserInfo_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                ...
                //{
                //    userInfo.Extcredits1 = decimal.Parse(extcredits1.Text);
                //}
                //else
                //{
                ...
                //{
                //    userInfo.Extcredits2 = decimal.Parse(extcredits2.Text);
                //}
                //else
                //{
                //    base.RegisterStartupScript("", "<script>alert('用户扩展积分不能为空或大于7位 !');</script>");
                ...
                //{
                //    userInfo.Extcredits3 = decimal.Parse(extcredits3.Text);
                //}
                //else
                //{
                //    base.RegisterStartupScript("", "<script>alert('用户扩展积分不能为空或大于7位 !');</script>");
                ...
                //{
                //    userInfo.Extcredits4 = decimal.Parse(extcredits4.Text);
                //}
                //else
                //{
                //    base.RegisterStartupScript("", "<script>alert('用户扩展积分不能为空或大于7位 !');</script>");
                ...
                //{
                //    userInfo.Extcredits5 = decimal.Parse(extcredits5.Text);
                //}
                //else
                //{
                //    base.RegisterStartupScript("", "<script>alert('用户扩展积分不能为空或大于7位 !');</script>");
                ...
                //{
                //    userInfo.Extcredits6 = decimal.Parse(extcredits6.Text);
                //}
                //else
                //{
                //    base.RegisterStartupScript("", "<script>alert('用户扩展积分不能为空或大于7位 !');</script>");
                ...
                //{
                //    userInfo.Extcredits7 = decimal.Parse(extcredits7.Text);
                //}
                //else
                //{
                //    base.RegisterStartupScript("", "<script>alert('用户扩展积分不能为空或大于7位 !');</script>");
                ...
                //{
                //    userInfo.Extcredits8 = decimal.Parse(extcredits8.Text);
                //}
                //else
                //{
                //    base.RegisterStartupScript("", "<script>alert('用户扩展积分不能为空或大于7位 !');</script>");
