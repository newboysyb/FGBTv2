...
namespace Discuz.Web.Admin
{
    ...
    public partial class syslogin : Page
    {
        ...
        public void VerifyLoginInf()
        {
            ...
            //    userInfo = Users.GetUserInfo(PTUsers.CheckPassword(DNTRequest.GetString("username"), DNTRequest.GetString("password"), true));
            //else//第三方加密验证模式
            //    userInfo = Users.CheckThirdPartPassword(DNTRequest.GetString("username"), DNTRequest.GetString("password"), -1, null);
            
            //新密码体系验证用户密码，暂时为原始密码
            userInfo = Users.GetUserInfo(PTUsers.CheckPasswordSHA512(DNTRequest.GetString("username"), DNTRequest.GetString("password"), true, false, "", false));
