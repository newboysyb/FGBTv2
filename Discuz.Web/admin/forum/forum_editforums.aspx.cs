...
namespace Discuz.Web.Admin
{
    ...
    public partial class editforums : AdminPage
    {
        ...
        public void LoadCurrentForumInfo(int fid)
        {
            ...
            if ((forumInfo.Allowpostspecial & 64) != 0) setting.Items[16].Selected = true;
            if ((forumInfo.Allowpostspecial & 128) != 0) setting.Items[17].Selected = true;
        ...
        private void SubmitInfo_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                if (DNTRequest.GetString("fid") != "")
                {
                    ...
                    temppostspecial = setting.Items[16].Selected ? temppostspecial | 64 : temppostspecial & ~64;
                    temppostspecial = setting.Items[17].Selected ? temppostspecial | 128 : temppostspecial & ~128;
