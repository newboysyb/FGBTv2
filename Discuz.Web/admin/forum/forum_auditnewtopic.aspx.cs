...
namespace Discuz.Web.Admin
{
    ...
    public partial class auditnewtopic : AdminPage
    {
        ...
        /// <param name="e"></param>
        private void SelectPassToForum25_Click(object sender, EventArgs e)
        {
            #region 对选中的主题设置为通过审核
            ...
            if (this.CheckCookie())
            {
                ...
                if (tidlist != "")
                {
                    ...
                    TopicAdmins.MoveTopics(tidlist, 25, 50, 0);
                    Topics.PassAuditNewTopic(tidlist);
                    AdminForumStats.ReSetFourmTopicAPost(25);
                    Forums.SetRealCurrentTopics(25);
                    Forums.UpdateLastPost(Forums.GetForumInfo(25));
                    base.RegisterStartupScript("", "<script>window.location='forum_auditnewtopic.aspx';</script>");
                }
                else
                {
        ...
        private void InitializeComponent()
        {
            ...
            this.SelectPassToForum25.Click += new EventHandler(this.SelectPassToForum25_Click);
        }
