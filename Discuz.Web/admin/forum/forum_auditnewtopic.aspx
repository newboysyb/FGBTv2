...
<head>
    ...
    <script type="text/javascript">
        ...
        function Check(form) {
            ...
            checkedEnabledButton(form, 'tid', 'SelectPassToForum25', 'SelectDelete');
        }
...
<body>
                    ...
                    <table class="datalist" id="topiclist" style="border-collapse: collapse;" border="1"
                        ...
                        <tbody>
                            ...
                            <tr class="mouseoutstyle" onmouseover="this.className='mouseoverstyle'" onmouseout="this.className='mouseoutstyle'">
                                <td style="border: 1px solid rgb(234, 233, 225);" nowrap="nowrap">
                                    <input id="tid" onclick="checkedEnabledButton(this.form,'tid','SelectPass','SelectDelete');checkedEnabledButton(form, 'tid', 'SelectPassToForum25', 'SelectDelete');"
    ...
    <p style="text-align: right;">
        ...
        &nbsp;&nbsp;
        <cc1:Button id="SelectPassToForum25" runat="server" Text=" 通过到品茶亭" Enabled="false">
        </cc1:Button>
        &nbsp;&nbsp;
