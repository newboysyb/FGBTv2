...
browserVersion({'ie':'msie','ie11':'trident','firefox':'','chrome':'','opera':'','safari':'','mozilla':'','webkit':'','maxthon':'','qq':'qqbrowser'});
if(BROWSER.safari) {
...
function browserVersion(types) {
	...
	for(i in types) {
		...
		/*ie11*/
		if(i=='ie11' && ver >= 7 && BROWSER.ie == null){
        eval('BROWSER.' + 'ie11' + '= ver');
        eval('BROWSER.' + 'firefox' + '= ver');
    }
		else if((i=='firefox' && (BROWSER.ie11 == null)) || (i!='firefox' && i!='ie11')) {
		if(ver > 0) eval('BROWSER.' + i + '= ver');
		}
	}
	BROWSER.other = other;
}
...
JSMENU['drag'] = [];
JSMENU['layer'] = 0;
JSMENU['zIndex'] = {'win':200,'menu':300,'prompt':99999,'dialog':500}; /*【BT修改】prompt 400->9999*/
JSMENU['float'] = '';
...
function ajaxpost(formid, showid, waitid, showidclass, submitbtn, recall) {
	...
	var handleResult = function () {
	    ...
	    showloading('none');
	    try {
	        if (BROWSER.ie && BROWSER.ie != "9.0" && BROWSER.ie != "10.0" && BROWSER.ie != "11.0") {
...
function floatwin(action, script, w, h, scrollpos) {
	...
	if(action == 'open') {
        ...
        addopenedwin('FLOATWIN|close_' + handlekey);
        ...
        removeopenedwin('FLOATWIN|close_' + handlekey);
...
function noticewin(s, t, c) {
	...
	s = '<table cellspacing="0" cellpadding="0" class="popupcredit"><tr><td class="pc_l">&nbsp;</td><td class="pc_c"><div class="pc_inner">' + s +
		(c ? '<a class="pc_btn" href="javascript:;" onclick="display(\'ntcwin\');setcookie(\'discuz_creditnoticedisable\', 1, 259200);" title="72小时内不要再提示我"><img src="' + IMGDIR + '/popupcredit_btn.gif" alt="不要再提示我" /></a>' : '') +
...
function AC_GetArgs(args, classid, mimeType)
{
 ...
 function newShowMenu(v) {
	...
	if(!fade) {
		...
		menuObj.style.filter = 'progid:DXImageTransform.Microsoft.Alpha(opacity=100)'; /*【BT修改】100->0*/
		menuObj.style.opacity = 1; /*【BT修改】1->0*/
		menuObj.fade = true;
	}
	...
	if(!$(menuid)) {
		...
		if(ctrlid) {
			...
			msg = '<table cellspacing="0" cellpadding="0" class="popupcredit"><tr><td class="pc_l">&nbsp;</td><td class="pc_c"><div class="pc_inner">' + msg +
				(negligible ? '<a class="pc_btn" href="javascript:;" onclick="display(\'ntcwin\');setcookie(\'discuz_creditnoticedisable\', 1, 259200);" title="不要再提示我"><img src="' + IMGDIR + '/popupcredit_btn.gif" alt="不要再提示我" /></a>' : '') +
				'</td><td class="pc_r">&nbsp;</td></tr></table>';
		}
		div.innerHTML = msg;
	}
...
function widthauto(obj,cssdir) {
    ...
    window.setTimeout("setMenuPosition('notice_ntc', 'notice_ntc_menu', '43');", 100);
}
