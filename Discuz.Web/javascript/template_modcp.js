...
function chageclass(about, id) {
    switch (about) {
        case "topicover":
            ...
            /*【BT修改】if(jQuery("#tbody_" + id).is(":hidden"))
            {
        ...
        case "topicout":
            ...
            /*【BT修改】if(jQuery("#tbody_" + id).is(":visible"))
            {
