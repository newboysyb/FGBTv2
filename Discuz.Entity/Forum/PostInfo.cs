...
namespace Discuz.Entity
{
    ...
    public class PostInfo
    {
        ...
        private int m_rootparentid = 0; //最高层父贴
        private int m_parentid = 0;	//父帖ID
        private int m_replied = 0; //是否被回复
        ...
        {
            get { return m_rootparentid; }
            set { m_rootparentid = value; }
        }
        ///<summary>
        ///父帖ID
        ///</summary>
        ...
        public int Replied
        {
            get { return m_replied; }
            set { m_replied = value; }
        }
        ///<summary>
        ///帖子所处层次（区分主题帖还是回帖？0为主题帖，1为回帖）
        ///</summary>
        public int Layer
        {
            get { return m_layer; }
