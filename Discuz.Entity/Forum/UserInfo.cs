...
namespace Discuz.Entity
{
	...
	public class ShortUserInfo
	{
        ...
        /// 扩展积分9 今天真实上传
        /// </summary>
        public decimal Extcredits9;
        /// <summary>
        /// 扩展积分10 今天真实下载
        /// </summary>
        public decimal Extcredits10;
        ...
        private int m_vip;              //是否VIP
        private decimal m_upload;     //名义上传
        private decimal m_download;   //名义下载
        private double m_ratio;      //名义分享率
        private int m_ratioprotection;     //共享率保护
        private int m_upcount;       //正在做种的数目
        private int m_donwncount;    //正在下载的数目
        private int m_finished;      //下载完成的数量
        private int m_published;     //发布的种子数量
        //private decimal m_realupload;     //真实上传
        //private decimal m_realdownload;   //真实下载
        private string m_passkey;    //用户识别码128bit

        public int Inviterid; //邀请用户id

        /// <summary>
        /// 共享率保护
        /// </summary>
        public int RatioProtection
        {
            get { return m_ratioprotection; }
            set { m_ratioprotection = value; }
        }
        /// <summary>
        /// 是否VIP
        /// </summary>
        ...
        {
            get { return m_donwncount; }
            set { m_donwncount = value; }
        }
        ...
        ///// 真实上传流量
        ///// </summary>
        //public decimal RealUpload
        //{
        //    get { return m_realupload; }
        //    set { m_realupload = value; }
        //}

        ///// <summary>
        ///// 真实下载流量
        ///// </summary>
        //public decimal RealDownload
        //{
        //    get { return m_realdownload; }
        //    set { m_realdownload = value; }
        //}
        ...
        /// 上次签到时间
        /// </summary>
        public DateTime LastCheckInTime = new DateTime(1970, 1, 1);
        /// <summary>
        /// 上次签到连续签到次数
        /// </summary>
        public int LastCheckInCount = 0;
