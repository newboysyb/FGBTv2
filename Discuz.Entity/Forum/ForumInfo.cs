...
//		private string m_postattachbyuser; //用户身份上传附件权限设定,格式:username1,username2|uid1,uid2
        ...
        private string m_rulesubb;
        private int m_rulesishtml;
        private string m_descriptionubb;
        private int m_descriptionishtml;

        /// <summary>
        /// 存储UBB或未经审批的html版头
        /// </summary>
        public string RulesUBB
        {
            get { return m_rulesubb; }
            set { m_rulesubb = value; }
        }
        /// <summary>
        /// 是否是html版头，2待审批，1是，0否
        /// </summary>
        public int RulesIsHTML
        {
            get { return m_rulesishtml; }
            set { m_rulesishtml = value; }
        }
        /// <summary>
        /// 存储UBB或未经审核的html版头
        /// </summary>
        public string DescriptionUBB
        {
            get { return m_descriptionubb; }
            set { m_descriptionubb = value; }
        }
        /// <summary>
        /// 是否是html版头，2待审批，1是，0否
        /// </summary>
        public int DescriptionIsHTML
        {
            get { return m_descriptionishtml; }
            set { m_descriptionishtml = value; }
        }
