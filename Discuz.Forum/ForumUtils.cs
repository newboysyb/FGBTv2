...
namespace Discuz.Forum
{
    ...
    public class ForumUtils
    {
        ...
        public static bool IsCrossSitePost(string urlReferrer, string host)
        {
            ...
            //////////////////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////////////// 
            //【BT修改】添加 CNGI登陆不检测跨站，移动版不检测跨站

            if (urlReferrer.IndexOf("http://sp-bbs.buaa6.edu.cn/") > -1)
            {
                if (urlReferrer.Length > 27) if (urlReferrer.Substring(0, 27) == "http://sp-bbs.buaa6.edu.cn/" && host == "bt.buaa6.edu.cn") return false;
            }
            else if (urlReferrer.IndexOf("http://m.buaabt.cn/") > -1)
            {
                if (urlReferrer.Length > 19) if (urlReferrer.Substring(0, 19) == "http://m.buaabt.cn/" && host == "ipv4.buaabt.cn") return false;
            }
        ...
        public static string ConvertDateTime(string date, DateTime currentDateTime)
        {
            ...
            TimeSpan timeresult = currentDateTime - time;

            if (timeresult.TotalSeconds < 10)
            {
                return "刚刚";
            }
            else if (timeresult.TotalSeconds < 60)
            {
                return timeresult.TotalSeconds.ToString("0") + "秒前";
            }
            else if (timeresult.TotalMinutes < 60)
            {
                return timeresult.TotalMinutes.ToString("0") + "分钟前";
            }
            else if (timeresult.TotalHours < 10)
            {
                if (currentDateTime.Day != time.Day)
                {
                    return "昨天" + time.ToString("HH") + ":" + time.ToString("mm") + "";
                }
                return timeresult.TotalHours.ToString("0") + "小时前";
            }
            else if (timeresult.TotalHours < 24)
            {
                if (currentDateTime.Day != time.Day)
                {
                    return "昨天" + time.ToString("HH") + ":" + time.ToString("mm");
        ...
        //////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////// 
        //【BT修改】xx小时内发布的帖子，颜色改为暗红色



        public static string ConvertDateTimeWithColor(string date)
        {
            return ConvertDateTimeWithColor(date, DateTime.Now);
        }
        /// <summary>
        /// 【BT修改】增加颜色显示的，把两个时间差，三天内的时间用今天，昨天，前天表示，后跟时间，无日期
        /// </summary>
        /// <param name="date">被比较的时间</param>
        /// <param name="currentDateTime">目标时间</param>
        /// <returns></returns>
        public static string ConvertDateTimeWithColor(string date, DateTime currentDateTime)
        {
            if (Utils.StrIsNullOrEmpty(date))
                return "";
            ...
            return ConvertDateTimeWithColor(time, currentDateTime);
        }
        ...
        /// <param name="currentDateTime">目标时间</param>
        /// <returns></returns>
        public static string ConvertDateTimeWithColor(DateTime time, DateTime currentDateTime)
        {
            TimeSpan timeresult = currentDateTime - time;

            if (timeresult.TotalSeconds < 10)
            {
                return "<span class=\"PrivateBTPostDateTimeHighlightNow\">" + "刚才</span>";
            }
            else if(timeresult.TotalSeconds < 60)
            {
                return "<span class=\"PrivateBTPostDateTimeHighlightSec\">" + timeresult.TotalSeconds.ToString("0") + "秒前</span>";
            }
            else if(timeresult.TotalMinutes < 60)
            {
                return "<span class=\"PrivateBTPostDateTimeHighlightMin\">" + timeresult.TotalMinutes.ToString("0") + "分钟前</span>";
            }
            else if (timeresult.TotalHours < 10)
            {
                if (currentDateTime.Day != time.Day)
                {
                    return "<span class=\"PrivateBTPostDateTimeHighlightHour\">" + "昨天" + time.ToString("HH") + ":" + time.ToString("mm") + "</span>";
                }
                return "<span class=\"PrivateBTPostDateTimeHighlightHour\">" + timeresult.TotalHours.ToString("0") + "小时前</span>";
            }
            else if(timeresult.TotalHours < 24)
            {
                if(currentDateTime.Day != time.Day)
                {
                    return "<span class=\"PrivateBTPostDateTimeHighlightYesterday\">" + "昨天" + time.ToString("HH") + ":" + time.ToString("mm") + "</span>";
                }
                return "<span class=\"PrivateBTPostDateTimeHighlightDay\">" + "今天" + time.ToString("HH") + ":" + time.ToString("mm") + "</span>";
            }
            else
            {
                return time.ToString("yyyy-MM-dd HH:mm");
        ...
        public static string ConvertDateTimeWithColorFull(DateTime date)
        {
            return ConvertDateTimeWithColorFull(date, DateTime.Now);
        }
        public static string ConvertDateTimeWithColorFull(string date)
        {
            if (Utils.StrIsNullOrEmpty(date))
                return "";
            ...
            return ConvertDateTimeWithColorFull(time, DateTime.Now);
        }
        /// <summary>
        /// 【BT修改】增加颜色显示的，把两个时间差，三天内的时间用今天，昨天，前天表示，后跟时间，无日期
        /// </summary>
        ...
        /// <param name="currentDateTime">目标时间</param>
        /// <returns></returns>
        public static string ConvertDateTimeWithColorFull(DateTime time, DateTime currentDateTime)
        {
            TimeSpan timeresult = currentDateTime - time;

            if (timeresult.TotalSeconds < 10)
            {
                return "<span class=\"PrivateBTPostDateTimeHighlightNow\">" + "" + timeresult.TotalSeconds.ToString("0") + "秒前</span>";
            }
            else if (timeresult.TotalSeconds < 60)
            {
                return "<span class=\"PrivateBTPostDateTimeHighlightSec\">" + timeresult.TotalSeconds.ToString("0") + "秒前</span>";
            ...
            {
                return "<span class=\"PrivateBTPostDateTimeHighlightMin\">" + ((int)(timeresult.TotalMinutes)).ToString("0") + "分" + (timeresult.TotalSeconds - 60 * (int)(timeresult.TotalMinutes)).ToString("0") + "秒前</span>";
            }
            else if (timeresult.TotalHours < 10)
            {
                if (currentDateTime.Day != time.Day)
                {
                    return "<span class=\"PrivateBTPostDateTimeHighlightHour\">" + "昨天" + time.ToString("HH:mm:ss.ff") + "</span>";
                }
                return "<span class=\"PrivateBTPostDateTimeHighlightHour\">" + "今天" + time.ToString("HH:mm:ss.ff") + "</span>";
            ...
            else if (timeresult.TotalHours < 24)
            {
                if (currentDateTime.Day != time.Day)
                {
                    return "<span class=\"PrivateBTPostDateTimeHighlightYesterday\">" + "昨天" + time.ToString("HH:mm:ss.ff") + "</span>";
                }
                return "<span class=\"PrivateBTPostDateTimeHighlightDay\">" + "今天" + time.ToString("HH:mm:ss.ff") + "</span>";
            }
            else
            {
                return time.ToString("yyyy-MM-dd HH:mm");
        ...
        {
            return ConvertDateTimeWithColor(time, DateTime.Now);
        }
        ...
        public static string ConvertCreditAndAmountToWord(int credit, int amount)
        {
            ...
            {
                return string.Format("{0}{1}", extcreditnames[credit], PTTools.Upload2Str((decimal)amount, true));
            }
