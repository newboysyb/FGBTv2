...
namespace Discuz.Forum
{
    ...
    public class UserCredits
    {
        ...
        /// </summary>
        public static int UpdateUserCredits(int uid, bool updatecookie)
        {
            ...
            if (userInfo != null)
            {
                ...
                //【BT修改】需加try，否则后台调用，如计划任务，会导致出现异常
                if (updatecookie)
                {
                    try
                    {
        ...
        /// <summary>
        /// 根据积分公式更新用户积分,Tracker简化版
        /// <param name="uid">用户ID</param>
        /// </summary>
        public static void UpdateUserCreditsForTracker(int uid)
        {
            Discuz.Data.UserCredits.UpdateUserCreditsForTracker(uid);
        }

        /// <summary>
        /// 根据积分公式更新用户积分,并且受分数变动影响有可能会更改用户所属的用户组【修改非当前执行者的积分，不需要更新Cookie】
        /// <param name="uid">用户ID</param>
        /// </summary>
        public static int UpdateUserCreditsBackground(int uid)
        {
            return UpdateUserCredits(uid, false);
        }
        /// <summary>
        /// 根据积分公式更新用户积分,并且受分数变动影响有可能会更改用户所属的用户组
        /// <param name="uid">用户ID</param>
        ...
        {
            return UpdateUserCredits(uid, true);
        }
        ...
        public static UserGroupInfo GetCreditsUserGroupId(decimal Credits)
        {
