...
namespace Discuz.Forum
{
    ...
    public class Avatars
    {
        ...
        public static string GetAvatarUrl(string uid, AvatarSize avatarSize)
        {
            ...
            {
                ///////////////////////////////////////////////////////////////////
                //【BT修改】确认头像文件是否存在？？？？哪种效率高，程序确认或由用户浏览器发起请求，由IIS确认？
                if (File.Exists(System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "avatars\\" + physicsAvatarPath.Replace("/", "\\")))
                    return Utils.GetRootUrl(forumPath) + "avatars/" + physicsAvatarPath;
                else return string.Format("/images/common/noavatar_{0}.gif", size);
            }
        }
