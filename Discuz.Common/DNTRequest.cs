...
namespace Discuz.Common
{
	...
	public class DNTRequest
	{
		...
		{
            return GetString(strName, false).Trim();
		}
        /// <summary>
        /// 获得安全的表单参数的值, 已经过HTML编码
        /// </summary>
        /// <param name="strName">参数</param>
        /// <returns>Url或表单参数的值</returns>
        public static string GetEncodedString(string strName)
        {
            return Utils.HtmlEncode(GetString(strName, false).Trim());
        }
		...
		public static string GetIP()
		{
            ...
            //可信任的代理服务器//此处代码需要修改
            //if (result == "xxx.xxx.xxx.xxx" || result == "xxx.xxx.xxx.xxx" || result == "xxx.xxx.xxx.xxx")
            //{
            ...
            //【BT修改】IPv6支持
            if (string.IsNullOrEmpty(result))//|| (!Utils.IsIP(result) && !Utils.IsIPV6(result))
            {
                return "NULL";
            }
