...
namespace Discuz.Data
{
    ...
    public partial class DbHelper
    {
        ...
        //public static int ExecuteNonQuery1(CommandType commandType, string commandText, params DbParameter[] commandParameters)
        //{
...
//#endif
        ...
        /// <param name="commandParameters">SqlParamter参数数组</param>
        /// <returns>返回影响的行数</returns>
        public static int ExecuteNonQueryNoCheck(CommandType commandType, string commandText, params DbParameter[] commandParameters)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
        ...
        private static void PrepareCommand(DbCommand command, DbConnection connection, DbTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
...
#else
        private static void CheckQuery(string commandText, DateTime dtStart)
        {
#if RELEASEWEB
            DateTime dtEnd = DateTime.Now;
            double s = (dtEnd - dtStart).TotalSeconds;
            if (s > 3)
            {
                DbParameter[] parms = {
                                       DbHelper.MakeInParam("@logtype",(DbType)SqlDbType.TinyInt, 1, 0),
                                       DbHelper.MakeInParam("@logstatus",(DbType)SqlDbType.TinyInt, 1, 51),
                                       DbHelper.MakeInParam("@logaction",(DbType)SqlDbType.NVarChar, 50, "OverTime3"),
                                       DbHelper.MakeInParam("@message",(DbType)SqlDbType.NText, 5000, string.Format("{0} -SQL:{1}", s, commandText)),
                ...
                ExecuteNonQueryNoCheck(CommandType.Text, sqlstring, parms);
            }
            else if (s > 0.8)
            {
                DbParameter[] parms = {
                                       DbHelper.MakeInParam("@logtype",(DbType)SqlDbType.TinyInt, 1, 0),
                                       DbHelper.MakeInParam("@logstatus",(DbType)SqlDbType.TinyInt, 1, 51),
                                       DbHelper.MakeInParam("@logaction",(DbType)SqlDbType.NVarChar, 50, "OverTime1"),
                                       DbHelper.MakeInParam("@message",(DbType)SqlDbType.NText, 5000, string.Format("{0} -SQL:{1}", s, commandText)),
                                       DbHelper.MakeInParam("@time",(DbType)SqlDbType.DateTime, 8, DateTime.Now),
            ...
            if (s > 10)
            {
                DbParameter[] parms = {
                                       DbHelper.MakeInParam("@logtype",(DbType)SqlDbType.TinyInt, 1, 0),
                                       DbHelper.MakeInParam("@logstatus",(DbType)SqlDbType.TinyInt, 1, 51),
                                       DbHelper.MakeInParam("@logaction",(DbType)SqlDbType.NVarChar, 50, "T OverTime3"),
                                       DbHelper.MakeInParam("@message",(DbType)SqlDbType.NText, 5000, string.Format("{0} -SQL:{1}", s, commandText)),
                                       DbHelper.MakeInParam("@time",(DbType)SqlDbType.DateTime, 8, DateTime.Now),
            ...
            else if (s > 3)
            {
                DbParameter[] parms = {
                                       DbHelper.MakeInParam("@logtype",(DbType)SqlDbType.TinyInt, 1, 0),
                                       DbHelper.MakeInParam("@logstatus",(DbType)SqlDbType.TinyInt, 1, 0),
                                       DbHelper.MakeInParam("@logaction",(DbType)SqlDbType.NVarChar, 50, "T OverTime1"),
                                       DbHelper.MakeInParam("@message",(DbType)SqlDbType.NText, 5000, string.Format("{0} -SQL:{1}", s, commandText)),
                                       DbHelper.MakeInParam("@time",(DbType)SqlDbType.DateTime, 8, DateTime.Now),
