...
namespace Discuz.Data
{
    public class CreditsLogs
    {
        ...
        /// <param name="operation">积分操作(1=兑换, 2=转帐, 3=购买邀请, 4=种子管理, 5=系统处罚, 6=邀请用户奖励 ,7=邀请用户处罚, 8=管理转账)</param>
        ...
        public static DataTable GetCreditsLogList(int pagesize, int currentpage, int uid)
        {
            return DatabaseProvider.GetInstance().GetCreditsLogList(pagesize, currentpage, uid);
        }
