...
namespace Discuz.Data
{
    public class Stats
    {
        ...
        public static ShortUserInfo[] GetUserArray(string type, string postTableId)
        {
            //////////////////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////////////// 
            //【BT修改】20->200，float->decimal，增加变量i，修改username

            IDataReader reader = DatabaseProvider.GetInstance().GetUsersRank(200, postTableId, type);
            if (reader == null)
            ...
            while (reader.Read())
            {
                ...
                if(i < 21)
                    u.Username = "<span style=\"color:#F00\">" + (i).ToString("000") + "</span>  " + reader["username"].ToString();
                else if(i < 51)
                    u.Username = "<span style=\"color:#A05\">" + (i).ToString("000") + "</span>  " + reader["username"].ToString();
                else if(i < 101)
                    u.Username = "<span style=\"color:#50A\">" + (i).ToString("000") + "</span>  " + reader["username"].ToString();
                else
                    u.Username = "<span style=\"color:#00F\">" + (i).ToString("000") + "</span>  " + reader["username"].ToString();
                ...
                switch (type)
                {
                    ...
                    case "credits":
                        ...
                        break;
                    case "extcredits1":
                        u.Extcredits1 = TypeConverter.ObjectToDecimal(reader["extcredits1"]);
                        break;
                    case "extcredits2":
                        u.Extcredits2 = TypeConverter.ObjectToDecimal(reader["extcredits2"]);
                        break;
                    case "extcredits3":
                        u.Extcredits3 = TypeConverter.ObjectToDecimal(reader["extcredits3"]);
                        break;
                    case "extcredits4":
                        u.Extcredits4 = TypeConverter.ObjectToDecimal(reader["extcredits4"]);
                        break;
                    case "extcredits5":
                        u.Extcredits5 = TypeConverter.ObjectToDecimal(reader["extcredits5"]);
                        break;
                    case "extcredits6":
                        u.Extcredits6 = TypeConverter.ObjectToDecimal(reader["extcredits6"]);
                        break;
                    case "extcredits7":
                        u.Extcredits7 = TypeConverter.ObjectToDecimal(reader["extcredits7"]);
                        break;
                    case "extcredits8":
                        u.Extcredits8 = TypeConverter.ObjectToDecimal(reader["extcredits8"]);
                        break;
                    case "oltime":
        ...
        public static void UpdateStatCount(string brower, string os, string visitorsadd, bool sessionexist, bool isguest)
        {
            DatabaseProvider.GetInstance().UpdateStatCount(brower, os, visitorsadd, sessionexist, isguest);
        }
