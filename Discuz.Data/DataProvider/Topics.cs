...
namespace Discuz.Data
{
    public class Topics
    {
        ...
        /// <returns>主题总数</returns>
        public static int GetTopicCount(TopicListFilterInfo tlf)
        {
            return DatabaseProvider.GetInstance().GetTopicCount(tlf);
        }
        ...
        /// <returns>主题总数</returns>
        public static int GetTopicCount(string forumlist, int digest)
        {
            return DatabaseProvider.GetInstance().GetTopicCount(forumlist, digest);
        }
        /// <summary>
        ...
        /// <param name="condition">条件</param>
        /// <returns>主题总数</returns>
        public static int GetTopicCount(string forumlist, DateTime lastpost)
        {
            return DatabaseProvider.GetInstance().GetTopicCount(forumlist, lastpost);
        }
        ...
        /// <returns></returns>
        public static Discuz.Common.Generic.List<TopicInfo> GetTopicList(TopicListFilterInfo tlf)
        {
            Discuz.Common.Generic.List<TopicInfo> list = new Discuz.Common.Generic.List<TopicInfo>();
            IDataReader reader = DatabaseProvider.GetInstance().GetTopicList(tlf);
            while (reader.Read())
            {
                list.Add(LoadSingleTopicInfo(reader));
            }
        ...
        //    IDataReader reader = DatabaseProvider.GetInstance().GetTopicList(fid, pageSize, pageIndex, startNumber, condition);
        //    while (reader.Read())
        //    {
        //        list.Add(LoadSingleTopicInfo(reader));
        //    }
        ...
        //{
        //    Discuz.Common.Generic.List<TopicInfo> list = new Discuz.Common.Generic.List<TopicInfo>();
        //    IDataReader reader = DatabaseProvider.GetInstance().GetTopicListByDate(fid, pageSize, pageIndex, startNumber, condition, orderFields, sortType);
        //    while (reader.Read())
        //    {
        //        list.Add(LoadSingleTopicInfo(reader));
        //    }
        ...
        //{
        //    Discuz.Common.Generic.List<TopicInfo> list = new Discuz.Common.Generic.List<TopicInfo>();
        //    IDataReader reader = DatabaseProvider.GetInstance().GetTopicListByViewsOrReplies(fid, pageSize, pageIndex, startNumber, condition, orderFields, sortType);
        //    while (reader.Read())
        //    {
        //        list.Add(LoadSingleTopicInfo(reader));
        //    }
        ...
        /// <summary>
        /// 对符合 新帖,精华帖  的页面显示进行查询的函数，仅用于showtopiclist页面，显示新帖和精华帖
        /// </summary>
        /// <param name="pageSize">每个分页的主题数</param>
        /// <param name="pageIndex">分页页数</param>
        /// <param name="startNumber">置顶帖数量</param>
        ...
        /// <param name="sortType">升/降序,0为升序,非0为降序</param>
        /// <returns>主题列表</returns>
        public static Discuz.Common.Generic.List<TopicInfo> GetTopicListGlobalNewOrDigest(int pageSize, int pageIndex, int startNum, string forumlist, int digest, DateTime lastpost, string orderBy, int ascDesc)
        {
            Discuz.Common.Generic.List<TopicInfo> list = new Discuz.Common.Generic.List<TopicInfo>();
            IDataReader reader = null;
            if (digest >= 0)
                reader = DatabaseProvider.GetInstance().GetTopicListGlobalDigest(pageSize, pageIndex, startNum, forumlist, digest, orderBy, ascDesc);
            else
                reader = DatabaseProvider.GetInstance().GetTopicListGlobalNew(pageSize, pageIndex, startNum, forumlist, lastpost, orderBy, ascDesc);
        ...
        public static Discuz.Common.Generic.List<TopicInfo> GetTopicsByUserId(int userId, int pageIndex, int pageSize)
        {
            ...
            IDataReader reader = DatabaseProvider.GetInstance().GetTopicListByUserId(userId, pageIndex, pageSize);
        ...
        public static int DeleteTopic(int tid)
        {
            ...
            return Discuz.Data.TopicAdmins.SetTopicStatus(tid.ToString(), "displayorder", "-3");
        }
        ...
        /// <summary>
        /// 获取主题列表，管理页面使用，对应的数据库函数在WebsiteManage.cs里
        /// </summary>
        /// <param name="postName">分表名称</param>
        /// <param name="forumId">版块Id</param>
        /// <param name="posterList">作者列表</param>
        ...
        {
            return DatabaseProvider.GetInstance().GetTopicList(start_tid, end_tid);
        }
        ...
        private static TopicInfo LoadSingleTopicInfo(IDataReader reader)
        {
            ...
            topicInfo.SeedId = TypeConverter.ObjectToInt(reader["seedid"]);
