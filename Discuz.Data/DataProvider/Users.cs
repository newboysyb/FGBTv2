...
namespace Discuz.Data
{
    public class Users
    {
        ...
        public static UserInfo LoadSingleUserInfo(IDataReader reader)
        {
            ...
            userinfo.VIP = TypeConverter.StrToInt(reader["vip"].ToString());
            userinfo.Upload = TypeConverter.StrToDecimal(reader["extcredits3"].ToString());
            userinfo.Download = TypeConverter.StrToDecimal(reader["extcredits4"].ToString());
            userinfo.Ratio = TypeConverter.StrToFloat(reader["ratio"].ToString());
            userinfo.RatioProtection = TypeConverter.StrToInt(reader["ratioprotection"].ToString());
            userinfo.UpCount = TypeConverter.StrToInt(reader["uploadcount"].ToString());
            userinfo.DownCount = TypeConverter.StrToInt(reader["downloadcount"].ToString());
            userinfo.Finished = TypeConverter.StrToInt(reader["finishcount"].ToString());
            userinfo.Published = TypeConverter.StrToInt(reader["publishcount"].ToString());
            userinfo.Passkey = reader["passkey"].ToString();
            ...
            userinfo.LastCheckInTime = TypeConverter.StrToDateTime(Convert.ToDateTime(reader["lastcheckintime"]).ToString("yyyy-MM-dd HH:mm:ss.fff"));
            userinfo.LastCheckInCount = TypeConverter.ObjectToInt(reader["lastcheckincount"]);
            ...
            //原始
            userinfo.Extcredits1 = TypeConverter.StrToDecimal(reader["extcredits1"].ToString());
            userinfo.Extcredits2 = TypeConverter.StrToDecimal(reader["extcredits2"].ToString());
            userinfo.Extcredits3 = TypeConverter.StrToDecimal(reader["extcredits3"].ToString());
            userinfo.Extcredits4 = TypeConverter.StrToDecimal(reader["extcredits4"].ToString());
            userinfo.Extcredits5 = TypeConverter.StrToDecimal(reader["extcredits5"].ToString());
            userinfo.Extcredits6 = TypeConverter.StrToDecimal(reader["extcredits6"].ToString());
            userinfo.Extcredits7 = TypeConverter.StrToDecimal(reader["extcredits7"].ToString());
            userinfo.Extcredits8 = TypeConverter.StrToDecimal(reader["extcredits8"].ToString());
            userinfo.Extcredits9 = TypeConverter.StrToDecimal(reader["extcredits9"].ToString());
            userinfo.Extcredits10 = TypeConverter.StrToDecimal(reader["extcredits10"].ToString());
        ...
        public static ShortUserInfo LoadSingleShortUserInfo(IDataReader reader)
        {
            ...
            if (reader.Read())
            {
                ...
                //userInfo.LastCheckInTime = (DateTime)reader["lastcheckintime"];
                userInfo.LastCheckInTime = TypeConverter.StrToDateTime(Convert.ToDateTime(reader["lastcheckintime"]).ToString("yyyy-MM-dd HH:mm:ss.fff"));
                //userInfo.LastCheckInTime = TypeConverter.ObjectToDateTime((reader["lastcheckintime"]).ToString("yyyy-MM-dd HH:mm:ss.fff"));
                //userInfo.LastCheckInTime = TypeConverter.ObjectToDateTime(reader["lastcheckintime"]);
                userInfo.LastCheckInCount = TypeConverter.ObjectToInt(reader["lastcheckincount"]);

                userInfo.Credits = TypeConverter.StrToDecimal(reader["credits"].ToString());
                userInfo.Extcredits1 = TypeConverter.StrToDecimal(reader["extcredits1"].ToString());
                userInfo.Extcredits2 = TypeConverter.StrToDecimal(reader["extcredits2"].ToString());
                userInfo.Extcredits3 = TypeConverter.StrToDecimal(reader["extcredits3"].ToString());
                userInfo.Extcredits4 = TypeConverter.StrToDecimal(reader["extcredits4"].ToString());
        ...
        {
            DatabaseProvider.GetInstance().InsertUserFieldHistory(uid, moduid, modip, section, originalvalue, newvalue);
        }
