...
namespace Discuz.Data
{
    public class PrivateMessages
    {
        ...
        public static int DeletePrivateMessages(int userId, string pmitemidList, string ipdel)
        {
            return DatabaseProvider.GetInstance().DeletePrivateMessages(userId, pmitemidList, ipdel);
        }
