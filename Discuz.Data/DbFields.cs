...
namespace Discuz.Data
{
    public class DbFields
    {
        ...
        public const string ONLINE = "[olid],[rkey],[rkeyexpire],[rkeyexpiretime],[userid],[ip],[username],[nickname],[password],[groupid],[olimg],[adminid],[invisible],[action],[lastactivity],[lastposttime],[lastpostpmtime],[lastsearchtime],[lastupdatetime],[lastcheckintime],[lastcheckincount],[forumid],[forumname],[titleid],[title],[verifycode],[newpms],[newnotices],[pmsound]";
        ...
        //增加[rootparentid]和[replied]，用于楼中楼显示模式
        public const string POSTS = "[pid],[fid],[tid],[rootparentid],[parentid],[replied],[layer],[poster],[posterid],[title],[postdatetime],[message],[ip],[lastedit],[invisible],[usesig],[htmlon],[smileyoff],[parseurloff],[bbcodeoff],[attachment],[rate],[ratetimes]";
        ...
        //【BT修改】原始，新代码见下方  public const string TOPICS = "[tid],[fid],[iconid],[typeid],[readperm],[price],[poster],[posterid],[title],[attention],[postdatetime],[lastpost],[lastpostid],[lastposter],[lastposterid],[views],[replies],[displayorder],[highlight],[digest],[rate],[hide],[attachment],[moderated],[closed],[magic],[identify],[special]";

        //【BT修改】原始，新代码见下方  public const string TOPICS_JOIN = "[t].[tid],[t].[fid],[t].[iconid],[t].[typeid],[t].[readperm],[t].[price],[t].[poster],[t].[posterid],[t].[title],[t].[attention],[t].[postdatetime],[t].[lastpost],[t].[lastpostid],[t].[lastposter],[t].[lastposterid],[t].[views],[t].[replies],[t].[displayorder],[t].[highlight],[t].[digest],[t].[rate],[t].[hide],[t].[attachment],[t].[moderated],[t].[closed],[t].[magic],[t].[identify],[t].[special]";
        ...
        /// <summary>
        /// 临时作为gettopiclist使用，待优化
        /// </summary>
        public const string TOPICS_GETLIST1 = "[rate],[tid],[seedid],[fid],[iconid],[typeid],[title],[price],[hide],[readperm],[special],[poster],[posterid],[replies],[views],[postdatetime],[lastpost],[lastposter],[lastpostid],[lastposterid],[highlight],[digest],[displayorder],[attachment],[closed],[magic]";

        //public const string TOPICS_GETLIST2 = "[fid],[tid],[seedid],[iconid],[title],[price],[typeid],[hide],[readperm],[special],[poster],[posterid],[replies],[views],[postdatetime],[lastpost],[lastposter],[lastpostid],[lastposterid],[highlight],[digest],[displayorder],[attachment],[closed],[magic],[rate]";

        //public const string TOPICS_GETLIST3 = "[fid],[tid],[seedid],[iconid],[title],[price],[typeid],[readperm],[hide],[special],[poster],[posterid],[replies],[views],[postdatetime],[lastpost],[lastposter],[lastpostid],[lastposterid],[highlight],[digest],[displayorder],[attachment],[closed],[magic],[rate]";

        //public const string TOPICS_GETLIST4 = "[rate],[tid],[seedid],[fid],[iconid],[typeid],[title],[price],[hide],[readperm],[special],[poster],[posterid],[replies],[views],[postdatetime],[lastpost],[lastposter],[lastpostid],[lastposterid],[replies],[highlight],[digest],[displayorder],[attachment],[closed],[magic],[special]";


        public const string TOPICS = "[tid],[seedid],[fid],[iconid],[typeid],[readperm],[price],[poster],[posterid],[title],[attention],[postdatetime],[lastpost],[lastpostid],[lastposter],[lastposterid],[views],[replies],[displayorder],[highlight],[digest],[rate],[hide],[attachment],[moderated],[closed],[magic],[identify],[special]";

        public const string TOPICS_JOIN = "[t].[tid],[t].[seedid],[t].[fid],[t].[iconid],[t].[typeid],[t].[readperm],[t].[price],[t].[poster],[t].[posterid],[t].[title],[t].[attention],[t].[postdatetime],[t].[lastpost],[t].[lastpostid],[t].[lastposter],[t].[lastposterid],[t].[views],[t].[replies],[t].[displayorder],[t].[highlight],[t].[digest],[t].[rate],[t].[hide],[t].[attachment],[t].[moderated],[t].[closed],[t].[magic],[t].[identify],[t].[special]";

        public const string USERS = "[uid],[vip],[uploadcount],[downloadcount],[passkey],[publishcount],[finishcount],[ratio],[ratioprotection],[username],[nickname],[password],[secques],[spaceid],[gender],[adminid],[groupid],[groupexpiry],[extgroupids],[regip],[joindate],[lastip],[lastvisit],[lastactivity],[lastpost],[lastcheckintime],[lastcheckincount],[lastpostid],[lastposttitle],[posts],[digestposts],[oltime],[pageviews],[credits],[extcredits1],[extcredits2],[extcredits3],[extcredits4],[extcredits5],[extcredits6],[extcredits7],[extcredits8],[extcredits9],[extcredits10],[avatarshowid],[email],[bday],[sigstatus],[tpp],[ppp],[templateid],[pmsound],[showemail],[invisible],[newpm],[newpmcount],[accessmasks],[onlinestate],[newsletter],[salt]";

        public const string USERS_JOIN_FIELDS = "[u].[uid],[u].[vip],[u].[uploadcount],[u].[downloadcount],[u].[passkey],[u].[publishcount],[u].[finishcount],[u].[ratio],[u].[ratioprotection],[u].[username],[u].[nickname],[u].[password],[u].[secques],[u].[spaceid],[u].[gender],[u].[adminid],[u].[groupid],[u].[groupexpiry],[u].[extgroupids],[u].[regip],[u].[joindate],[u].[lastip],[u].[lastvisit],[u].[lastactivity],[u].[lastpost],[u].[lastpostid],[u].[lastposttitle],[u].[lastcheckintime],[u].[lastcheckincount],[u].[posts],[u].[digestposts],[u].[oltime],[u].[pageviews],[u].[credits],[u].[extcredits1],[u].[extcredits2],[u].[extcredits3],[u].[extcredits4],[u].[extcredits5],[u].[extcredits6],[u].[extcredits7],[u].[extcredits8],[u].[extcredits9],[u].[extcredits10],[u].[avatarshowid],[u].[email],[u].[bday],[u].[sigstatus],[u].[tpp],[u].[ppp],[u].[templateid],[u].[pmsound],[u].[showemail],[u].[invisible],[u].[newpm],[u].[newpmcount],[u].[accessmasks],[u].[onlinestate],[u].[newsletter], [uf].[website],[uf].[icq],[uf].[qq],[uf].[yahoo],[uf].[msn],[uf].[skype],[uf].[location],[uf].[customstatus],[uf].[avatar],[uf].[avatarwidth],[uf].[avatarheight],[uf].[medals],[uf].[bio],[uf].[signature],[uf].[sightml],[uf].[authstr],[uf].[authtime],[uf].[authflag],[uf].[realname],[uf].[idcard],[uf].[mobile],[uf].[phone],[uf].[ignorepm],[u].[salt]";
