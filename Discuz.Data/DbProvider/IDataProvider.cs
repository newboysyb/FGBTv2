...
namespace Discuz.Data
{
    public partial interface IDataProvider
    {
        ...
        void InsertUserFieldHistory(int uid, int moduid, string modip, string section, string originalvalue, string newvalue);
        ...
        int DeletePrivateMessages(int userId, string pmIdList, string ipdel);
        /// <summary>
        /// 删除评分日志
        /// </summary>
        /// <param name="pid">帖子Id</param>
        ...
        /// <param name="condition">查询条件</param>
        /// <returns>主题总数</returns>
        int GetTopicCount(TopicListFilterInfo tlf);
        /// <summary>
        /// 获取通告
        /// </summary>
        ...
        /// <returns></returns>
        DataTable GetOnlineUserByRKey(int userId, string rkey);
        /// <summary>
        /// 获取在线用户数
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="condition">条件</param>
        /// <returns>主题总数</returns>
        int GetTopicCount(string forumlist, DateTime lastpost);
        /// <summary>
        /// 得到符合条件的主题总数:条件 digest，forumlist
        /// </summary>
        /// <param name="condition">条件</param>
        /// <returns>主题总数</returns>
        int GetTopicCount(string forumlist, int digest);
        /// <summary>
        /// 获取主题所属板块Id
        /// </summary>
        /// <param name="tidList"></param>
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetForumHotTopicsList();
        ...
        /// <returns></returns>
        IDataReader GetTopicList(int startTid, int endTid);
        ...
        /// <returns></returns>
        IDataReader GetTopicList(TopicListFilterInfo tlf);
        ...
        ///// <param name="condition"></param>
        ///// <returns></returns>
        //IDataReader GetTopicList(int fid, int pageSize, int pageIndex, int startNum, string condition);
        ///// <summary>
        ///// 获取主题列表
        ///// </summary>
        ///// <param name="fid"></param>
        ...
        ///// <returns></returns>
        //IDataReader GetTopicListByDate(int fid, int pageSize, int pageIndex, int startNumber, string condition, string orderFields, int sortType);
        ///// <summary>
        ///// 按浏览数和回帖数排序读取版块列表
        ///// </summary>
        ///// <param name="fid"></param>
        ...
        ///// <param name="sortType"></param>
        ///// <returns></returns>
        //IDataReader GetTopicListByViewsOrReplies(int fid, int pageSize, int pageIndex, int startNumber, string condition, string orderFields, int sortType);

        /// <summary>
        /// 获取指定条件的主题列表，此函数用于管理，在websitemanage.cs内
        /// </summary>
        /// <param name="postName">分表名称</param>
        ...
        /// <returns></returns>
        IDataReader GetTopicListGlobalDigest(int pageSize, int pageIndex, int startNum, string forumlist, int digest, string orderBy, int ascDesc);
        /// <summary>
        /// 获取主题列表
        /// </summary>
        /// <param name="pageSize"></param>
        ...
        /// <param name="ascDesc"></param>
        /// <returns></returns>
        IDataReader GetTopicListGlobalNew(int pageSize, int pageIndex, int startNum, string forumlist, DateTime lastpost, string orderBy, int ascDesc);
        /// <summary>
        /// 获取主题列表
        /// </summary>
        /// <param name="userId"></param>
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        IDataReader GetTopicListByUserId(int userId, int pageIndex, int pageSize);
        /// <summary>
        /// 获取主题数
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="postTableName"></param>
        /// <returns></returns>
        int UpdatePostSetRepliedTrue(int pid, string postTableName);
        /// <summary>
        /// 设置帖子是否被回复
        /// </summary>
        /// <param name="pid"></param>
        ...
        /// <param name="postTableName"></param>
        /// <returns></returns>
        int UpdatePostSetReplied(int pid, int tid, string postTableName);
        /// <summary>
        /// 更新帖子信息
        /// </summary>
        ...
        /// <param name="postTableId"></param>
        /// <returns></returns>
        int UpdatePost(PostInfo postsInfo, string postTableId, int uid, string ip);
        /// <summary>
        /// 更新帖子信息
        /// </summary>
        ...
        void UpdateStatCount(string browser, string os, string visitorsAdd, bool sessionexist, bool isguest);
        /// <summary>
        /// 增加辩论主题扩展信息
        /// </summary>
        ...
        decimal GetUserExtCreditsByUserid(int uid, int extNumber);
        /// <summary>
        /// 查看用户是否购买过指定附件
        /// </summary>
